...
export default function LoginPage() {
    ...
    // Precarga el bundle del dashboard mientras la persona todavía está llenando
    // el formulario, para que al loguearse la entrada sea instantánea (sin esperar
    // a que Next.js recién ahí empiece a descargar/compilar la página).
    useEffect(() => {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                // replace (no push): entra directo al dashboard sin dejar el login
                // en el historial, y ya venía precargado por el prefetch de arriba.
        ...
        <div style={{ background: "#030303", minHeight: "100vh", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
            <div style={{ maxWidth: 400, width: "100%" }}>
                ...
                <div style={{ textAlign: "center", marginBottom: 40 }}>
                    <div style={{ width: 64, height: 64, background: "rgba(239, 68, 68,0.1)", borderRadius: 16, display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 16px" }}>
                ...
                <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                    ...
                    <button
                        disabled={isLoading}
                        type="submit"
                        style={{ background: "#EF4444", color: "#fff", border: "none", padding: 16, borderRadius: 12, fontWeight: 700, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, marginTop: 12 }}
                    >
                    ...
                    <p style={{ textAlign: "center", color: "#9CA3AF", fontSize: 14, marginTop: 8 }}>
                        ¿Aún no tienes cuenta? <Link href="/signup" style={{ color: "#EF4444", textDecoration: "none", fontWeight: 600 }}>Crea una hoy</Link>
                    </p>
                </form>
            </div>
        </div>
