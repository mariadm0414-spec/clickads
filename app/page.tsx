...
function FaqItem({ q, a }: { q: string; a: string }) {
    ...
    return (
        <div style={{ background: "#0D0D14", border: `1px solid ${open ? "rgba(110,0,255,0.35)" : "rgba(255,255,255,0.07)"}`, borderRadius: 16, overflow: "hidden", transition: "border-color 0.2s" }}>
...
function GalaxyCanvas() {
    ...
    return <canvas ref={canvasRef} id="galaxy-canvas" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', pointerEvents: 'none', zIndex: 0 }} />;
}
        ...
        <div style={{ background: "#030303", minHeight: "100vh", color: "#fff", fontFamily: "'Inter', sans-serif", overflowX: "hidden", position: "relative" }}>
            ...
            <style>{`
                ...
                * { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                .feature-card { background: rgba(110,0,255,0.03); border: 1px solid rgba(110,0,255,0.1); border-radius: 24px; padding: 32px; transition: all 0.3s; }
                .feature-card:hover { border-color: rgba(110,0,255,0.3); background: rgba(110,0,255,0.06); }

                /* Galaxy starfield canvas */
                #galaxy-canvas { position: absolute; top: 0; left: 0; width: 100%; height: 100%; pointer-events: none; z-index: 0; }
            ...
            <section className="hero-section" style={{ padding: "140px 24px 80px", position: "relative", overflow: "hidden", background: "#030303", minHeight: "100vh", display: "flex", alignItems: "center" }}>
                ...
                <div style={{ maxWidth: 1000, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 2, width: "100%" }}>
                    ...
                    <h1 style={{ fontSize: "clamp(38px, 7vw, 72px)", fontWeight: 900, lineHeight: 1.1, letterSpacing: "-0.03em", marginBottom: 32, color: "#fff" }}>
                        Sube la foto de tu producto y deja que la IA de ClickADS <br />
                        <span className="gradient-text">cree +100 imagenes que vendan en Meta ADS</span><br />
                        en segundos.
                    </h1>
                    ...
                    <p style={{ fontSize: 20, color: "#A76EFF", maxWidth: 750, margin: "0 auto 48px", lineHeight: 1.7, fontWeight: 400 }}>
                        ...
                        <strong style={{ color: "#8E44FF" }}>Sin límites de creación. Úsala para todos tus productos.</strong>
                    </p>
                ...
                <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
                    ...
                    <div style={{ marginTop: 100, textAlign: "center" }}>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 32, marginBottom: 64 }} className="mobile-grid-1">
                            {/* Card 1: DIY */}
                            <div className="feature-card" style={{ textAlign: "left", background: "#0D0D14" }}>
                                <div style={{ borderRadius: 20, overflow: "hidden", marginBottom: 24, aspectRatio: "16/10" }}>
                                    <img src="/diy_creative_struggle_1774410418170.png" alt="DIY" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                                </div>
                            ...
                            <div className="feature-card" style={{ textAlign: "left", background: "#0D0D14" }}>
                                <div style={{ borderRadius: 20, overflow: "hidden", marginBottom: 24, aspectRatio: "16/10" }}>
                                    <img src="/expensive_agency_bill_1774410465150.png" alt="Agencias" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                                </div>
                            ...
                            <div className="feature-card" style={{ textAlign: "left", background: "#0D0D14" }}>
                                <div style={{ borderRadius: 20, overflow: "hidden", marginBottom: 24, aspectRatio: "16/10" }}>
                                    <img src="/big_brands_ads_scale_1774410505031.png" alt="Grandes Marcas" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                                </div>
            ...
            <section style={{ padding: "100px 24px", background: "#030303", borderTop: "1px solid rgba(110,0,255,0.1)" }}>
                <div style={{ maxWidth: 1000, margin: "0 auto", textAlign: "center" }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 16, maxWidth: 840, margin: "0 auto" }}>
                        {/* Bloque Naranja */}
                        <div style={{ background: "rgba(251,146,60,0.08)", border: "1px solid rgba(251,146,60,0.25)", padding: "22px 32px", borderRadius: 20, fontSize: 18, color: "#FED7AA", fontWeight: 500, lineHeight: 1.5, textAlign: "left" }} className="mobile-pill">
                        ...
                        {/* Bloque Rojo */}
                        <div style={{ background: "rgba(239,68,68,0.08)", border: "1px solid rgba(239,68,68,0.25)", padding: "22px 32px", borderRadius: 20, fontSize: 18, color: "#FECACA", fontWeight: 500, lineHeight: 1.5, textAlign: "left" }} className="mobile-pill">
                            <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }} className="mobile-col-center">
                        ...
                        <div style={{ background: "rgba(107,114,128,0.08)", border: "1px solid rgba(107,114,128,0.25)", padding: "22px 32px", borderRadius: 20, fontSize: 18, color: "#E5E7EB", fontWeight: 500, lineHeight: 1.5, textAlign: "left" }} className="mobile-pill">
                            <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }} className="mobile-col-center">
                                <span style={{ fontSize: 24, flexShrink: 0 }}>🚩</span>
                                <div>
                        ...
                        <div style={{ background: "rgba(110,0,255,0.1)", border: "1px solid rgba(110,0,255,0.3)", padding: "26px 32px", borderRadius: 20, fontSize: 18, color: "#A76EFF", fontWeight: 500, lineHeight: 1.5, textAlign: "left", marginTop: 8, boxShadow: "0 0 40px rgba(110,0,255,0.08)" }} className="mobile-pill">
                            <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }} className="mobile-col-center">
            ...
            <section style={{ padding: "80px 24px", background: "linear-gradient(180deg, #0D0D14 0%, #030303 100%)" }}>
                <div style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }} className="mobile-grid-1">
                    ...
                    <div style={{ textAlign: "left" }}>
                        <div style={{ background: "rgba(110,0,255,0.1)", border: "1px solid rgba(110,0,255,0.2)", color: "#8E44FF", fontSize: 11, fontWeight: 800, padding: "6px 16px", borderRadius: 100, display: "inline-flex", alignItems: "center", gap: 8, marginBottom: 24 }}>
                        ...
                        <p style={{ fontSize: 17, color: "#9CA3AF", lineHeight: 1.7, marginBottom: 36, maxWidth: 520 }}>
                        ...
                        <a href="#precio" className="btn-primary" style={{ padding: "18px 40px", borderRadius: 16, fontSize: 18 }}>
                            ✦ ACCEDER A LA APP
                        </a>
                    </div>
            ...
            <section style={{ padding: "120px 24px", background: "linear-gradient(180deg, #030303 0%, #0D0D14 100%)" }}>
                <div style={{ maxWidth: 1200, margin: "0 auto", textAlign: "center" }}>
                    <div style={{ background: "rgba(110,0,255,0.1)", border: "1px solid rgba(110,0,255,0.2)", color: "#8E44FF", fontSize: 12, fontWeight: 800, padding: "8px 20px", borderRadius: 100, display: "inline-block", marginBottom: 24 }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }} className="mobile-grid-1">
                        <div style={{ position: "relative" }} className="slider-container">
                            <BeforeAfterSlider
                                ...
                                after="/photo-studio/Modelo.jpeg"
                        ...
                        <div style={{ textAlign: "center" }}>
                            ...
                            <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.05)", borderRadius: 24, padding: 32, display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
                                <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 16 }}>
                                    <div style={{ background: "#6E00FF", color: "#fff", width: 32, height: 32, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 900 }}>✓</div>
                    ...
                    <div style={{ marginTop: 40, padding: "60px", background: "rgba(255,255,255,0.02)", borderRadius: 40, border: "1px solid rgba(255,255,255,0.05)" }} className="mobile-full-padding">
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 40, alignItems: "center" }} className="mobile-grid-1">
                            ...
                            <div style={{ borderRadius: 24, overflow: "hidden", boxShadow: "0 20px 40px rgba(0,0,0,0.5)" }}>
                                <img src="/photo-studio/imagen_despues_fondo_blanco.jpeg" alt="Fondo Blanco 3D" style={{ width: "100%", display: "block" }} />
