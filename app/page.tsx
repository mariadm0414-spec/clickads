                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1.1fr 1fr", gap: 48, alignItems: "center" }} className="mobile-grid-1">
                        ...
                        <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                            <div style={{ 
                                ...
                                borderRadius: 24,
                                padding: 12,
                                boxShadow: "0 30px 60px rgba(0,0,0,0.6), 0 0 50px rgba(16, 185, 129, 0.15)"
                            }}>
                                <img 
                                    src="/ugc/wa_reviews_tool.jpg" 
                                    alt="WhatsApp Reviews AI Interface" 
                                    style={{ 
                                        width: "100%", 
                                        height: "auto", 
                                        borderRadius: 16,
