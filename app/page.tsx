...
function BeforeAfterSlider({
    ...
    return (
        <div
            ref={containerRef}
            style={{ position: "relative", userSelect: "none", cursor: "ew-resize", borderRadius: 24, overflow: "hidden", boxShadow: "0 0 60px rgba(239, 68, 68,0.2)", aspectRatio: "4/5" }}
        ...
        >
            <div style={{ position: "relative", width: "100%", height: "100%" }}>
                ...
                <div style={{ position: "absolute", top: 16, right: 16, fontSize: 11, fontWeight: 900, letterSpacing: "0.1em", background: "rgba(239, 68, 68,0.85)", backdropFilter: "blur(6px)", color: "#fff", padding: "5px 12px", borderRadius: 100, zIndex: 10 }}>{afterLabel}</div>
            </div>
            <div style={{
        ...
        <div style={{
            ...
            <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: 13, color: "#D1D5DB", lineHeight: 1.3 }}>
                    <strong style={{ color: "#fff" }}>{notifications[current].name}</strong> acabo de comprar <strong style={{ color: "#F87171" }}>"oferta pago unico"</strong>
                </div>
            </div>
            <style>{`
        ...
        <div style={{ background: "#030303", minHeight: "100vh", color: "#fff", fontFamily: "'Inter', sans-serif", overflowX: "hidden", position: "relative" }}>
            ...
            <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 1000, background: "rgba(3,3,3,0.8)", backdropFilter: "blur(20px)", padding: "14px 24px", borderBottom: "1px solid rgba(239, 68, 68,0.15)", transition: "all 0.3s" }}>
                <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                        <Zap size={28} style={{ color: "#EF4444", fill: "#EF4444" }} />
                        <span style={{ fontSize: 22, fontWeight: 900, letterSpacing: "-0.04em", color: "#fff" }}>
                            Click<span style={{ color: "#EF4444" }}>Ads</span>
                        </span>
                    </div>
                    <div style={{ display: "flex", gap: 16, alignItems: "center" }}>
                        <a href="#precio" className="btn-primary" style={{ padding: "10px 24px", fontSize: 14, background: "linear-gradient(135deg, #EF4444, #DC2626)", boxShadow: "0 4px 20px rgba(239, 68, 68,0.4)" }}>ACCEDER A LA APP</a>
                    </div>
                </div>
            </nav>
            ...
            <section className="hero-section" style={{ padding: "140px 24px 80px", position: "relative", overflow: "hidden", background: "transparent", minHeight: "100vh", display: "flex", alignItems: "center" }}>
                ...
                <div style={{ maxWidth: 1000, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 2, width: "100%" }}>
                    ...
                    <h1 style={{ fontSize: "clamp(38px, 7vw, 72px)", fontWeight: 900, lineHeight: 1.1, letterSpacing: "-0.03em", marginBottom: 32, color: "#fff" }}>
                        Genera <span style={{ color: "#EF4444" }}>+100</span><br />
                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 12, marginBottom: 40, flexWrap: "wrap", position: "relative", zIndex: 10 }}>
                        ...
                        <div style={{ textAlign: "left" }}>
                            ...
                            <div style={{ fontSize: 14, fontWeight: 700, color: "#9CA3AF" }}>
                                <span style={{ color: "#FCA5A5" }}>+1,200</span> Dropshippers y dueños de Ecommerce ya escalan con <span style={{ color: "#fff" }}>ClickADS</span>
                            </div>
                        </div>
                    </div>
            ...
            <footer style={{ padding: "80px 24px 40px", borderTop: "1px solid rgba(255,255,255,0.05)", textAlign: "center" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10, justifyContent: "center", marginBottom: 24 }}>
                    <Zap size={36} style={{ color: "#EF4444", fill: "#EF4444" }} />
                    <span style={{ fontSize: 24, fontWeight: 900, letterSpacing: "-0.04em" }}>
                        Click<span style={{ color: "#EF4444" }}>Ads</span>
                    </span>
                </div>
