        ...
        <div style={{
            ...
            <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: 13, color: "#D1D5DB", lineHeight: 1.3 }}>
                    <strong style={{ color: "#fff" }}>{notifications[current].name}</strong> acabo de comprar <strong style={{ color: "#8E44FF" }}>"oferta pago unico"</strong>
                </div>
            </div>
            <style>{`
...
export default function Home() {
    ...
    return (
        <div style={{ background: "#030303", minHeight: "100vh", color: "#fff", fontFamily: "'Inter', sans-serif", overflowX: "hidden", position: "relative" }}>
                ...
                <div style={{ maxWidth: 1000, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 2, width: "100%" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 12, marginBottom: 40, flexWrap: "wrap", position: "relative", zIndex: 10 }}>
                        ...
                        <div style={{ textAlign: "left" }}>
                            ...
                            <div style={{ fontSize: 14, fontWeight: 700, color: "#9CA3AF" }}>
                                <span style={{ color: "#A76EFF" }}>+1,200</span> Dropshippers y dueños de Ecommerce ya escalan con <span style={{ color: "#fff" }}>ClickADS</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style={{ maxWidth: 800, margin: "0 auto 64px", borderRadius: 32, overflow: "hidden", border: "1px solid rgba(110,0,255,0.25)", boxShadow: "0 30px 80px rgba(110,0,255,0.2), 0 0 0 1px rgba(110,0,255,0.1)" }}>
                        <div style={{ position: "relative", paddingBottom: "56.25%", height: 0 }}>
                            <iframe
                                src="https://www.youtube.com/embed/l62SLsWgVIg"
                    ...
                    <div style={{ marginTop: 64, marginBottom: 64, textAlign: "center" }}>
                        ...
                        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: 48, flexWrap: "wrap", opacity: 0.8 }}>
                            ...
                            <div style={{ background: "rgba(110,0,255,0.05)", border: "1px solid rgba(110,0,255,0.15)", padding: "10px 24px", borderRadius: 100, fontSize: 14, fontWeight: 700, color: "#9CA3AF" }}>
                                ⚡ <span style={{ color: "#A76EFF" }}>+50,000</span> creativos generados
                            </div>
                        </div>
                        <p style={{ marginTop: 48, fontSize: 16, color: "#9CA3AF", maxWidth: 600, margin: "48px auto 0", lineHeight: 1.6 }}>
                            ...
                            <strong style={{ color: "#fff", borderBottom: "2px solid #6E00FF" }}>inteligencia artificial de Meta Andromeda</strong>
                        </p>
                    </div>
            ...
            {/* AI WhatsApp Closer Simulator Section */}
            <section style={{ padding: "100px 24px", background: "linear-gradient(180deg, transparent, rgba(37, 211, 102, 0.05))", position: "relative", zIndex: 10 }}>
                <div style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "1.1fr 1fr", gap: 80, alignItems: "center" }} className="mobile-stack">
                    <div style={{ order: 2 }}>
                        <img
                            src="/simulador-closer/simulador-closer-preview.png"
                            alt="Simulador Closer"
                            style={{
                                width: "100%",
                                borderRadius: 32,
                                border: "1px solid rgba(37, 211, 102, 0.2)",
                                boxShadow: "0 40px 80px rgba(37, 211, 102, 0.15), 0 0 0 1px rgba(37, 211, 102, 0.1)"
                            }}
                        />
                    </div>

                    <div style={{ order: 1 }}>
                        <div style={{ background: "rgba(37, 211, 102, 0.1)", border: "1px solid rgba(37, 211, 102, 0.2)", color: "#25D366", fontSize: 13, fontWeight: 800, padding: "8px 20px", borderRadius: 100, display: "inline-flex", alignItems: "center", gap: 10, marginBottom: 32 }} className="mobile-center-flex">
                            <MessageSquare size={14} /> EXCLUSIVO EN CLICKADS
                        </div>
                        <h2 style={{ fontSize: "clamp(32px, 5vw, 64px)", fontWeight: 900, lineHeight: 1.1, marginBottom: 32 }}>
                            La Única App con el <br />
                            <span style={{ color: "#25D366" }}>Simulador Closer</span> <br />
                            del Mercado
                        </h2>
                        <p style={{ fontSize: 19, color: "#9CA3AF", lineHeight: 1.7, marginBottom: 40, maxWidth: 540 }} className="mobile-center-flex">
                            ¿Tienes miedo de quemar clientes en WhatsApp? ClickAds es la primera y única plataforma que incluye un simulador de entrenamiento basado en IA.
                            <br /><br />
                            <strong>Entrena tus ventas antes de hablar con clientes reales.</strong> Nuestra IA simula comportamientos de clientes reales, te pone objeciones difíciles y al finalizar te da un informe detallado de cómo mejorar tu cierre.
                        </p>
                        <div style={{ display: "flex", flexDirection: "column", gap: 18, marginBottom: 40 }} className="mobile-center-flex">
                            {[
                                { text: "Simulaciones ilimitadas con clientes difíciles" },
                                { text: "Informes de evaluación de cierre automáticos" },
                                { text: "Domina el manejo de objeciones por chat" }
                            ].map((item, i) => (
                                <div key={i} style={{ display: "flex", alignItems: "center", gap: 14, fontSize: 16, fontWeight: 600, color: "#E5E7EB" }}>
                                    <div style={{ color: "#25D366", fontSize: 20, fontWeight: 900, flexShrink: 0 }}>✓</div> {item.text}
                                </div>
                            ))}
                        </div>
                        <div style={{ display: "flex", gap: 16 }} className="mobile-center-flex">
                            <a href="#precio" className="btn-primary" style={{ padding: "18px 40px", borderRadius: 16, fontSize: 18, fontWeight: 900, background: "linear-gradient(135deg, #25D366, #128C7E)", boxShadow: "0 10px 30px rgba(37, 211, 102, 0.3)" }}>✦ EMPEZAR A ENTRENAR</a>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section style={{ padding: "100px 24px" }}>
                ...
                <div style={{ marginTop: 140, textAlign: "center" }}>
                    ...
                    <div style={{
                        marginTop: 40,
                        background: "linear-gradient(135deg, rgba(110,0,255,0.15) 0%, rgba(110,0,255,0.05) 100%)",
                        ...
                        <div style={{ position: "absolute", top: 0, left: "50%", transform: "translateX(-50%)", width: "100%", height: "100%", background: "radial-gradient(ellipse 60% 60% at 50% 0%, rgba(110,0,255,0.2) 0%, transparent 70%)", pointerEvents: "none" }}></div>
                        <div style={{ position: "relative", zIndex: 2 }}>
                            <div style={{ background: "#6E00FF", color: "#fff", fontSize: 11, fontWeight: 900, padding: "6px 16px", borderRadius: 100, display: "inline-block", marginBottom: 24 }}>SISTEMA DE INVESTIGACIÓN (VALORADO EN $199 USD)</div>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                            {[
                                ...
                                <div key={idx} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: 15, borderBottom: idx !== 9 ? "1px solid rgba(255,255,255,0.03)" : "none", paddingBottom: idx !== 9 ? 16 : 0 }}>
                                    ...
                                    <div style={{ color: "#A76EFF", fontWeight: 700 }}>{item.v}</div>
                                </div>
                            ))}
                        </div>
                    </div>
