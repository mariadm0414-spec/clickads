            ...
            <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 1000, background: "rgba(3,3,3,0.8)", backdropFilter: "blur(20px)", padding: "14px 24px", borderBottom: "1px solid rgba(139, 92, 246,0.15)", transition: "all 0.3s" }}>
                <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    ...
                    <div style={{ display: "flex", gap: 16, alignItems: "center" }}>
                        <a href="#precio" className="btn-primary" style={{ padding: "10px 24px", fontSize: 14, background: "linear-gradient(135deg, #8B5CF6, #7C3AED)", boxShadow: "0 4px 20px rgba(139, 92, 246,0.4)" }}>Acceder a la APP Con Descuento</a>
                    </div>
                </div>
            </nav>
                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 12, marginBottom: 40, flexWrap: "wrap", position: "relative", zIndex: 10 }}>
                        ...
                        <div style={{ textAlign: "left" }}>
                            ...
                            <div style={{ fontSize: 14, fontWeight: 700, color: "#9CA3AF" }}>
                                <span style={{ color: "#C4B5FD" }}>+1,200</span> Dropshippers y dueños de Ecommerce ya escalan con <span style={{ color: "#fff" }}>ClickADS</span>
                            </div>
                        </div>
                    </div>
            ...
            <section style={{ padding: "0 24px 100px", background: "transparent", position: "relative", zIndex: 3, overflow: "hidden" }}>
                <div style={{ textAlign: "center" }}>
                    <h2 style={{ fontSize: "clamp(32px, 6vw, 56px)", fontWeight: 900, marginBottom: 16 }}>
                        ...
                        <span className="desktop-hide" style={{ fontSize: "28px" }}>+50 creativos generados con ClickAds</span>
                    </h2>
                    ...
                    <div style={{ maxWidth: 1400, margin: "0 auto", overflow: "hidden", position: "relative" }}>
                        {/* Mobile Grid */}
                        <div className="desktop-hide mobile-gallery-grid" style={{ marginBottom: 40 }}>
                            {[
                                ...
                                <div key={`mob-${i}`} className="mobile-gallery-item">
                                    <Image src={`/imagenes-creadas/${img}`} alt="Creativo" fill style={{ objectFit: "cover" }} sizes="33vw" />
                                </div>
                            ))}
                        </div>
