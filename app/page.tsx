...
function FaqItem({ q, a }: { q: string; a: string }) {
    ...
    return (
        <div style={{ background: "#0D0D14", border: `1px solid ${open ? "rgba(239, 68, 68,0.35)" : "rgba(255,255,255,0.07)"}`, borderRadius: 16, overflow: "hidden", transition: "border-color 0.2s", position: "relative", zIndex: 10 }}>
            <button onClick={() => setOpen(!open)} style={{ width: "100%", background: "none", border: "none", color: open ? "#F87171" : "#fff", fontFamily: "Inter, sans-serif", fontSize: 16, fontWeight: 600, textAlign: "left", padding: "20px 24px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16, cursor: "pointer" }}>
                {q}
                <Plus size={20} style={{ color: "#EF4444", transition: "transform 0.25s", transform: open ? "rotate(45deg)" : "rotate(0deg)" }} />
            </button>
    ...
    return (
        <div style={{ background: "#030303", minHeight: "100vh", color: "#fff", fontFamily: "'Inter', sans-serif", overflowX: "hidden", position: "relative" }}>
            ...
            <style>{`
                ...
                .gradient-text { background: linear-gradient(135deg, #EF4444 0%, #F87171 50%, #FCA5A5 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
                .btn-primary { background: linear-gradient(135deg, #EF4444, #DC2626); color: #fff; padding: 16px 32px; border-radius: 12px; font-weight: 700; text-decoration: none; display: inline-flex; transition: all 0.25s; align-items: center; gap: 8px; border: none; cursor: pointer; }
                .btn-primary:hover { transform: translateY(-3px); box-shadow: 0 16px 40px rgba(239, 68, 68,0.5); filter: brightness(1.1); }
                .btn-cta { font-size: 20px; padding: 24px 48px; border-radius: 20px; box-shadow: 0 0 50px rgba(239, 68, 68,0.4); }

                .pain-card { background: #120A0A; border: 1px solid rgba(239, 68, 68, 0.2); border-radius: 24px; padding: 32px; transition: all 0.3s; position: relative; z-index: 5; }
                .pain-card:hover { border-color: rgba(239, 68, 68, 0.4); background: #1A0D0D; }

                .feature-card { background: #0A0A12; border: 1px solid rgba(239, 68, 68,0.2); border-radius: 24px; padding: 32px; transition: all 0.3s; position: relative; z-index: 5; }
                .feature-card:hover { border-color: rgba(239, 68, 68,0.4); background: #0E0E18; }
                ...
                @keyframes pulse-glow {
                    0%, 100% { box-shadow: 0 0 40px rgba(239, 68, 68,0.4), 0 0 80px rgba(239, 68, 68,0.15); }
                    50% { box-shadow: 0 0 60px rgba(239, 68, 68,0.6), 0 0 120px rgba(239, 68, 68,0.25); }
                }
                .pulse-btn { animation: pulse-glow 3s ease-in-out infinite; }
            `}</style>

            {/* Header */}
            <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 1000, background: "rgba(3,3,3,0.8)", backdropFilter: "blur(20px)", padding: "14px 24px", borderBottom: "1px solid rgba(239, 68, 68,0.15)", transition: "all 0.3s" }}>
                <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                        ...
                        <span style={{ fontSize: 22, fontWeight: 900, letterSpacing: "-0.04em", color: "#fff" }}>
                            Click<span style={{ color: "#EF4444" }}>Ads</span>
                        </span>
                    </div>
                    <div style={{ display: "flex", gap: 16, alignItems: "center" }}>
                        <a href="#precio" className="btn-primary" style={{ padding: "10px 24px", fontSize: 14, background: "linear-gradient(135deg, #EF4444, #DC2626)", boxShadow: "0 4px 20px rgba(239, 68, 68,0.4)", whiteSpace: "nowrap" }}>
            ...
            <section className="hero-section" style={{ padding: "140px 24px 80px", position: "relative", overflow: "hidden", background: "transparent", minHeight: "100vh", display: "flex", alignItems: "center" }}>
                ...
                <div style={{ position: "absolute", top: 0, left: "50%", transform: "translateX(-50%)", width: "100%", height: "100%", background: "radial-gradient(ellipse 80% 60% at 50% 0%, rgba(239, 68, 68,0.25) 0%, transparent 70%)", pointerEvents: "none", zIndex: 1 }}></div>
                ...
                <div style={{ maxWidth: 1000, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 2, width: "100%" }}>
                    <div
                        ...
                        style={{ background: "rgba(239, 68, 68,0.15)", border: "1px solid rgba(239, 68, 68,0.4)", color: "#EF4444", fontSize: 13, fontWeight: 700, padding: "8px 24px", borderRadius: 100, display: "inline-flex", alignItems: "center", gap: 8, marginBottom: 32, maxWidth: "100%", backdropFilter: "blur(10px)", textTransform: "uppercase" }}
                    >
                        <span style={{ width: 8, height: 8, borderRadius: "50%", background: "#EF4444" }}></span> SISTEMA DE VOLUMEN EXTREMO PARA META ADS
                    </div>

                    <h1 style={{ fontSize: "clamp(38px, 7vw, 72px)", fontWeight: 900, lineHeight: 1.1, letterSpacing: "-0.03em", marginBottom: 32, color: "#fff" }}>
                        Genera <span style={{ color: "#EF4444" }}>+{creativeCount}</span><br />
                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 12, marginBottom: 40, flexWrap: "wrap", position: "relative", zIndex: 10 }}>
                        ...
                        <div style={{ textAlign: "left" }}>
                            ...
                            <div style={{ fontSize: 14, fontWeight: 700, color: "#9CA3AF" }}>
                                <span style={{ color: "#FCA5A5" }}>+1,200</span> Dropshippers y dueños de Ecommerce ya escalan con <span style={{ color: "#fff" }}>AdsTools</span>
                            </div>
                        </div>
                    </div>

                    <div style={{ maxWidth: 800, margin: "0 auto 64px", borderRadius: 32, overflow: "hidden", border: "1px solid rgba(239, 68, 68,0.25)", boxShadow: "0 30px 80px rgba(239, 68, 68,0.2), 0 0 0 1px rgba(239, 68, 68,0.1)" }}>
                    ...
                    <div style={{ marginTop: 64, marginBottom: 64, textAlign: "center" }}>
                        ...
                        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: 48, flexWrap: "wrap", opacity: 0.8 }}>
                            ...
                            <div style={{ background: "rgba(239, 68, 68,0.05)", border: "1px solid rgba(239, 68, 68,0.15)", padding: "10px 24px", borderRadius: 100, fontSize: 14, fontWeight: 700, color: "#9CA3AF" }}>
                                ⚡ <span style={{ color: "#FCA5A5" }}>+50,000</span> creativos generados
                            </div>
                        </div>
                        <p style={{ marginTop: 48, fontSize: 16, color: "#9CA3AF", maxWidth: 600, margin: "48px auto 0", lineHeight: 1.6 }}>
                            ...
                            <strong style={{ color: "#fff", borderBottom: "2px solid #EF4444" }}>inteligencia artificial de Meta Andromeda</strong>
                        </p>
                    </div>

                    <div style={{ display: "flex", gap: 16, justifyContent: "center" }} className="mobile-stack">
                        <a href="#precio" className="btn-primary btn-cta pulse-btn" style={{ background: "linear-gradient(135deg, #EF4444 0%, #DC2626 100%)", borderRadius: 12, padding: "16px 32px", fontSize: 18, fontWeight: 700, boxShadow: "0 0 50px rgba(239, 68, 68,0.5), inset 0 1px 0 rgba(255,255,255,0.2)", display: "inline-flex", alignItems: "center", gap: 8, textDecoration: "none" }}>
                            ...
                            <div key={idx} style={{ background: "#0D0D14", border: "1px solid rgba(255,255,255,0.05)", borderRadius: 32, padding: 24, textAlign: "left" }}>
                                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
                                    <div>
                                        ...
                                        <p style={{ fontSize: 12, color: "#EF4444", fontWeight: 700 }}>{video.name} - {video.role}</p>
                                    </div>
            ...
            <section style={{ padding: "120px 24px", background: "transparent", position: "relative", zIndex: 10 }}>
                <div style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1.1fr", gap: 80, alignItems: "center" }} className="mobile-stack">
                    <div className="mobile-text-center">
                        <div style={{ background: "rgba(239, 68, 68,0.1)", border: "1px solid rgba(239, 68, 68,0.2)", color: "#F87171", fontSize: 13, fontWeight: 800, padding: "8px 20px", borderRadius: 100, display: "inline-flex", alignItems: "center", gap: 10, marginBottom: 32 }} className="mobile-center-flex">
                        ...
                        <h2 style={{ fontSize: "clamp(32px, 5vw, 64px)", fontWeight: 900, lineHeight: 1.1, marginBottom: 32 }}>
                            Crea Landings de <br />
                            <span style={{ background: "rgba(239, 68, 68,0.15)", padding: "0 12px", borderRadius: 8 }}>Venta Profesionales</span> <br />
                    ...
                    <div style={{ position: "relative", display: "flex", justifyContent: "center" }}>
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
                            ...
                            <div style={{
                                ...
                                boxShadow: "0 60px 120px -20px rgba(0,0,0,0.9), 0 0 50px rgba(239, 68, 68,0.25)",
                                position: "relative",
                                overflow: "hidden"
                            }}>
                        ...
                        {/* Instruction Text */}
                        <div style={{ position: "absolute", bottom: -50, fontSize: 11, color: "#6B7280", fontWeight: 800, letterSpacing: 2, background: "rgba(239, 68, 68,0.05)", padding: "4px 12px", borderRadius: 100 }}>↓ HAZ SCROLL PARA VER LA LANDING</div>
                    </div>
                </div>
            </section>
                ...
                <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
                    ...
                    <div style={{
                        ...
                        <h3 style={{ fontSize: "clamp(24px, 4vw, 36px)", fontWeight: 800, lineHeight: 1.3 }}>
                            ...
                            <span style={{ color: "#EF4444", background: "rgba(239, 68, 68, 0.15)", padding: "0 10px", borderRadius: 8 }}>
                    ...
                    <div style={{ marginTop: 100, textAlign: "center" }}>
                        <div style={{ background: "rgba(239, 68, 68,0.1)", border: "1px solid rgba(239, 68, 68,0.2)", color: "#F87171", fontSize: 10, fontWeight: 800, padding: "6px 16px", borderRadius: 100, display: "inline-flex", alignItems: "center", gap: 8, marginBottom: 24 }}>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 32, marginBottom: 64 }} className="mobile-grid-1">
                            ...
                            <div className="feature-card" style={{ textAlign: "left", background: "#0D0D14", position: "relative", zIndex: 10 }}>
                                ...
                                <h3 style={{ fontSize: 22, fontWeight: 800, marginBottom: 16 }}>Hazlo tú mismo = <span style={{ color: "#EF4444" }}>Agotamiento</span></h3>
                                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                                    <div style={{ display: "flex", gap: 12, fontSize: 16, color: "#9CA3AF", lineHeight: 1.4 }}>
                                        <span style={{ color: "#EF4444" }}>❌</span> <span>Requiere horas de diseño y copywriting</span>
                                    </div>
                                    <div style={{ display: "flex", gap: 12, fontSize: 16, color: "#9CA3AF", lineHeight: 1.4 }}>
                                        <span style={{ color: "#EF4444" }}>❌</span> <span>No hay garantía de que el CTR sea alto</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="feature-card" style={{ textAlign: "left", background: "#0D0D14", position: "relative", zIndex: 10 }}>
                                ...
                                <h3 style={{ fontSize: 22, fontWeight: 800, marginBottom: 16 }}>Agencias = <span style={{ color: "#EF4444" }}>Caras y Lentas</span></h3>
                                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                                    <div style={{ display: "flex", gap: 12, fontSize: 16, color: "#9CA3AF", lineHeight: 1.4 }}>
                                        <span style={{ color: "#EF4444" }}>❌</span> <span>Más de $500 USD por set de anuncios</span>
                                    </div>
                                    <div style={{ display: "flex", gap: 12, fontSize: 16, color: "#9CA3AF", lineHeight: 1.4 }}>
                                        <span style={{ color: "#EF4444" }}>❌</span> <span>Largas esperas, poca flexibilidad</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="feature-card" style={{ textAlign: "left", background: "#0D0D14", position: "relative", zIndex: 10 }}>
                                ...
                                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                                    <div style={{ display: "flex", gap: 12, fontSize: 16, color: "#9CA3AF", lineHeight: 1.4 }}>
                                        <span style={{ color: "#EF4444" }}>❌</span> <span>Es imposible competir contra sus millones</span>
                                    </div>
                                    <div style={{ display: "flex", gap: 12, fontSize: 16, color: "#9CA3AF", lineHeight: 1.4 }}>
                                        <span style={{ color: "#EF4444" }}>❌</span> <span>Realizan pruebas A/B masivas cada hora</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style={{
                            ...
                            <p style={{ fontSize: 22, color: "#E5E7EB", lineHeight: 1.6 }}>
                                ...
                                <strong style={{ color: "#F87171" }}>Pero existe una forma más rápida, inteligente y económica de ganar...</strong>
                            </p>
                        </div>
                    </div>
            ...
            <section style={{ padding: "100px 24px", background: "transparent", borderTop: "1px solid rgba(239, 68, 68,0.1)" }}>
                <div style={{ maxWidth: 1000, margin: "0 auto", textAlign: "center" }}>
                    <h2 style={{ fontSize: "clamp(30px, 5vw, 56px)", fontWeight: 900, marginBottom: 32, lineHeight: 1.1, color: "#fff", letterSpacing: "-0.02em" }}>
                        El problema real... <br />
                        <span style={{ color: "#EF4444" }}>Usar IA genérica para crear imagenes para Pauta Publicitaria es como tirar tu presupuesto a la basura y esperar un milagro.</span>
                    </h2>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 16, maxWidth: 840, margin: "0 auto" }}>
                        ...
                        <div style={{ background: "#0D031A", border: "1px solid rgba(239, 68, 68,0.3)", padding: "26px 32px", borderRadius: 20, fontSize: 18, color: "#FCA5A5", fontWeight: 500, lineHeight: 1.5, textAlign: "left", marginTop: 8, boxShadow: "0 0 40px rgba(239, 68, 68,0.08)", position: "relative", zIndex: 10 }} className="mobile-pill">
                            <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }} className="mobile-col-center">
                                <span style={{ fontSize: 28, flexShrink: 0 }}>🎯</span>
                                <div>
                                    <strong style={{ color: "#fff", fontWeight: 800 }}>Tu marketing no es un experimento, es una inversión:</strong> Deja de "probar suerte" con IAs que no entienden de ventas. <strong style={{ color: "#F87171" }}>Menos arte, más ROI.</strong>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section style={{ padding: "80px 24px", background: "transparent" }}>
                <div style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }} className="mobile-grid-1">
                    ...
                    <div style={{ textAlign: "left" }} className="mobile-text-center">
                        <div style={{ background: "rgba(239, 68, 68,0.1)", border: "1px solid rgba(239, 68, 68,0.2)", color: "#F87171", fontSize: 11, fontWeight: 800, padding: "6px 16px", borderRadius: 100, display: "inline-flex", alignItems: "center", gap: 8, marginBottom: 24 }} className="mobile-center-flex">
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 18, marginBottom: 40 }} className="mobile-center-flex">
                            {[
                                ...
                                <div key={i} style={{ display: "flex", alignItems: "center", gap: 14, fontSize: 16, fontWeight: 600, color: "#E5E7EB" }}>
                                    <div style={{ color: "#EF4444", fontSize: 20, fontWeight: 900, flexShrink: 0 }}>✓</div> {item.text}
                                </div>
                            ))}
                        </div>
            ...
            <section style={{ padding: "100px 24px", textAlign: "center" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24, maxWidth: 1200, margin: "0 auto 60px" }} className="mobile-grid-1">
                    {[
                        ...
                        <div key={step.num} style={{
                            ...
                            <div style={{ background: "rgba(239, 68, 68,0.15)", color: "#EF4444", width: 44, height: 44, borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20, marginBottom: 24, margin: "0 auto 24px" }}>{step.icon}</div>
                ...
                <div style={{
                    ...
                    <p style={{ fontSize: "clamp(20px, 3vw, 28px)", fontWeight: 800 }}>
                        Genera <span style={{ color: "#fff" }}>100 creativos estáticos</span> en <span style={{ color: "#F87171" }}>~10 minutos.</span><br />
                        Listos para testear en <span style={{ color: "#EF4444" }}>Meta Ads.</span>
                    </p>
                </div>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24, maxWidth: 1200, margin: "0 auto" }} className="mobile-grid-1">
                        {[
                            ...
                            <div key={i} style={{
                                ...
                                <div style={{ background: "rgba(239, 68, 68,0.1)", color: "#EF4444", width: 44, height: 44, borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20, marginBottom: 24, margin: "0 auto 24px" }}>{item.icon}</div>
                        ...
                        <div className="custom-scrollbar" style={{ 
                            ...
                            {[
                                ...
                                <div key={i} style={{
                                    ...
                                    <Image src={`/testimonials/${img}`} alt="WhatsApp Testimonial" fill style={{ objectFit: "cover", objectPosition: "top" }} sizes="(max-width: 768px) 100vw, 33vw" />
                                </div>
                            ))}
                        </div>
                    </div>
                        ...
                        {[
                            ...
                            <div key={i} style={{
                                ...
                                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16, marginBottom: 20 }}>
                                    <div style={{ background: "rgba(239, 68, 68,0.1)", color: "#EF4444", width: 44, height: 44, borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center" }}>
                                        {item.icon}
                                    </div>
                                    <div>
                                        <div style={{ fontSize: 10, fontWeight: 800, color: "#EF4444", letterSpacing: "0.1em", textTransform: "uppercase" }}>Componente #{item.num}</div>
            ...
            <section style={{ padding: "100px 24px" }}>
                ...
                <div style={{ marginTop: 140, textAlign: "center" }}>
                    ...
                    <p style={{ fontSize: 18, color: "#9CA3AF", marginBottom: 64, opacity: 0.7 }}>También recibes estos <span style={{ color: "#F87171", fontWeight: 800 }}>BONUS GRATIS</span> al unirte hoy.</p>
                        ...
                        {[
                            ...
                            <div key={i} style={{
                                ...
                                <div style={{ display: "flex", justifyContent: "center", gap: 24, marginBottom: 20 }}>
                                    ...
                                    <div style={{ fontSize: 10, fontWeight: 800, color: "#EF4444", letterSpacing: "0.1em" }}>BONUS #{item.num}</div>
                                </div>
                    ...
                    <div style={{
                        ...
                        <div style={{ position: "absolute", top: 0, left: "50%", transform: "translateX(-50%)", width: "100%", height: "100%", background: "radial-gradient(ellipse 60% 60% at 50% 0%, rgba(239, 68, 68,0.2) 0%, transparent 70%)", pointerEvents: "none" }}></div>
                        <div style={{ position: "relative", zIndex: 2 }}>
                            <div style={{ background: "#EF4444", color: "#fff", fontSize: 11, fontWeight: 900, padding: "6px 16px", borderRadius: 100, display: "inline-block", marginBottom: 24 }}>SISTEMA DE INVESTIGACIÓN (VALORADO EN $199 USD)</div>
            ...
            <section style={{ padding: "120px 24px", background: "transparent", scrollMarginTop: "100px" }} id="precio" >
                <div style={{ maxWidth: 1100, margin: "0 auto", textAlign: "center" }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ fontSize: 12, fontWeight: 900, color: "#EF4444", letterSpacing: "0.2em", marginBottom: 32, textAlign: "center" }}>TODO LO QUE INCLUYE:</div>
                        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                            {[
                                ...
                                <div key={idx} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: 15, borderBottom: idx !== 9 ? "1px solid rgba(255,255,255,0.03)" : "none", paddingBottom: idx !== 9 ? 16 : 0 }}>
                                    ...
                                    <div style={{ color: "#FCA5A5", fontWeight: 700 }}>{item.v}</div>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div style={{
                        ...
                        margin: "0 auto",
                        textAlign: "center",
                        boxShadow: "0 40px 100px rgba(239, 68, 68,0.15)",
                        overflow: "hidden"
                        ...
                        <div style={{ marginTop: 40, marginBottom: 48 }}>
                            ...
                            <div style={{ marginTop: 24, marginBottom: 12 }}>
                                <span style={{ fontSize: 22, color: "#fff", fontWeight: 900, background: "rgba(239, 68, 68,0.2)", border: "1px solid rgba(239, 68, 68,0.4)", padding: "12px 32px", borderRadius: 100, display: "inline-block", letterSpacing: "0.02em" }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 20, textAlign: "left", maxWidth: 450, margin: "0 auto 64px" }}>
                            {[
                                ...
                                <div key={feat} style={{ display: "flex", alignItems: "center", gap: 16, fontSize: 18, color: "#D1D5DB", fontWeight: 600 }}>
                                    <div style={{ color: "#EF4444", fontSize: 20 }}>✓</div> {feat}
                                </div>
                            ))}
                        </div>

                        <a href={MONTHLY_CHECKOUT_URL} className="btn-primary" style={{ width: "100%", justifyContent: "center", padding: "24px 40px", borderRadius: 20, fontSize: 24, fontWeight: 900, boxShadow: "0 20px 40px rgba(239, 68, 68,0.3)" }}>
            ...
            <section style={{ padding: "80px 24px", background: "transparent" }}>
                <div style={{
                    ...
                    <div style={{ color: "#EF4444", fontSize: 12, fontWeight: 900, letterSpacing: "0.2em", marginBottom: 24, display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
