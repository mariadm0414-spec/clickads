                ...
                <div style={{ marginTop: 140, textAlign: "center" }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ position: "relative", zIndex: 2 }}>
                            <div style={{ background: "#6E00FF", color: "#fff", fontSize: 12, fontWeight: 900, padding: "6px 16px", borderRadius: 100, display: "inline-block", marginBottom: 20, boxShadow: "0 0 20px rgba(110,0,255,0.5)" }}>SUPER BONUS EXTRA (VALORADO EN $199 USD)</div>
                            ...
                            <p style={{ fontSize: "clamp(14px, 1.5vw, 16px)", color: "#8E44FF", lineHeight: 1.6, maxWidth: 700, margin: "20px auto 0", fontWeight: 700 }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                            {[
                                ...
                                { t: "BONUS: Clases de Ecommerce y Creativos", v: "$149" },
                                { t: "SUPER BONUS: Investigación de Producto IA", v: "$199" },
