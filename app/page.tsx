...
// ── Constants ─────────────────────────────────────────────────────────────
const MONTHLY_CHECKOUT_URL = "https://pay.hotmart.com/T106966232V?off=3xpo3bon";
const ANNUAL_CHECKOUT_URL = "https://pay.hotmart.com/T106966232V?off=3xpo3bon";
...
<section className="hero-section" style={{ padding: "100px 24px 80px", position: "relative", overflow: "hidden", background: "transparent", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
                ...
                <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 2, width: "100%" }}>
                    ...
                    <h1 style={{ fontSize: "clamp(48px, 8vw, 84px)", fontWeight: 700, lineHeight: 1.05, letterSpacing: "-0.04em", marginBottom: 32, color: "#fff" }}>
                        100 anuncios en lo que<br/>
                        <span style={{ fontFamily: "'Playfair Display', serif", fontStyle: "italic", fontWeight: 600, color: "#fff" }}>ChatGPT te hace uno.</span><br/>
                        Sin diseñador, sin grabar, sin promptear.
                    </h1>

                    <p style={{ fontSize: 18, color: "#9CA3AF", maxWidth: 550, margin: "0 auto 48px", lineHeight: 1.6, fontWeight: 400 }}>
                        No gana el que hace el anuncio perfecto: gana el que prueba 100 y se queda con el que vende. Cargas tu producto una vez y descargas los 100 anuncios enteros con ángulos de venta distintos, con tu marca, lista para subir a Meta esta tarde.
                    </p>
            ...
            <section style={{ padding: "0 24px 100px", background: "transparent", position: "relative", zIndex: 3 }}>
                <div style={{ textAlign: "center" }}>
                    <h2 style={{ fontSize: "clamp(32px, 6vw, 48px)", fontWeight: 900, marginBottom: 40 }}>La app por dentro <span className="gradient-text">se ve así:</span></h2>
                    ...
                    <div style={{ maxWidth: 800, margin: "0 auto", borderRadius: 32, overflow: "hidden", border: "1px solid rgba(139, 92, 246,0.25)", boxShadow: "0 30px 80px rgba(139, 92, 246,0.2), 0 0 0 1px rgba(139, 92, 246,0.1)", position: "relative", zIndex: 10 }}>
                        <div style={{ position: "relative", paddingBottom: "56.25%", height: 0 }}>
                            <iframe
                                src="https://www.loom.com/embed/ed1a8c2042b94607aaa17c909f3fdb9b"
                                frameBorder="0"
                                allowFullScreen
...
{/* Videos UGC Section */}
            <section style={{ padding: "100px 24px", background: "transparent", position: "relative", zIndex: 3 }}>
                <div style={{ textAlign: "center", maxWidth: 1200, margin: "0 auto" }}>
                    <h2 style={{ fontSize: "clamp(32px, 6vw, 56px)", fontWeight: 900, marginBottom: 16 }}>
                        Cuando tu ángulo pida video, <span className="gradient-text">también lo tienes.</span>
                    </h2>
                    <p style={{ fontSize: 18, color: "#9CA3AF", marginBottom: 40, maxWidth: 800, margin: "0 auto 40px", lineHeight: 1.6 }}>
                        La mayoría trabaja solo con imágenes. Si tu ángulo pide video, con <span style={{ color: "#fff", fontWeight: 700 }}>ClickAds</span> armas UGC con clips de personas reales + tu producto. No es un avatar hablando: son personas reales ensambladas a volumen para tus anuncios.
                    </p>

                    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 24, justifyItems: "center" }}>
                        {["u01.mp4", "u03.mp4", "u05.mp4", "u07.mp4", "u13.mp4", "u19.mp4"].map((videoFile, idx) => (
                            <div 
                                key={idx} 
                                style={{ position: "relative", borderRadius: 24, overflow: "hidden", background: "#0D0D14", border: "1px solid rgba(255,255,255,0.05)", width: "100%", maxWidth: 320, aspectRatio: "9/16" }}
                            >
                                <video
