            ...
            <section className="hero-section" style={{ padding: "140px 24px 80px", position: "relative", overflow: "hidden", background: "transparent", minHeight: "100vh", display: "flex", alignItems: "center" }}>
                ...
                <div style={{ maxWidth: 1000, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 2, width: "100%" }}>
                    ...
                    <h1 style={{ fontSize: "clamp(38px, 7vw, 72px)", fontWeight: 900, lineHeight: 1.1, letterSpacing: "-0.03em", marginBottom: 32, color: "#fff" }}>
                        Genera <span style={{ color: "#8B5CF6" }}>+{creativeCount}</span> anuncios (IMAGENES)<br />
                        de alta conversión<br />
                    ...
                    <p style={{ fontSize: 18, color: "#9CA3AF", maxWidth: 750, margin: "0 auto 16px", lineHeight: 1.7, fontWeight: 500 }}>
                        Ideal para ECommerce, cursos online y ofertas digitales.<br /><br />
                        Sube tu producto, selecciona el mensaje que quieres comunicar y obtén una biblioteca completa de creativos listos para escalar en Meta Ads.
                    </p>
                    ...
                    <div style={{
                        ...
                        <div style={{ marginTop: 40, marginBottom: 48 }}>
                            ...
                            <div style={{ display: "flex", alignItems: "baseline", justifyContent: "center", gap: 8 }}>
                                <span style={{ fontSize: "clamp(60px, 12vw, 96px)", fontWeight: 900, color: "#fff", letterSpacing: "-0.04em" }}>$9,99</span>
                ...
                <div style={{ maxWidth: 800, margin: "0 auto" }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                        {[
                            ...
                            {
                                q: "¿Es un pago único?",
                                a: "Sí, es un pago único de solo $9,99 USD para acceso de por vida a la herramienta. Sin cuotas mensuales ni cobros adicionales."
                            },
                            {
