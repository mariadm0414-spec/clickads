...
export default function Home() {
    ...
    // ── WhatsApp Reviews AI Simulator State ──
    const [waSimStep, setWaSimStep] = useState(0);
    useEffect(() => {
        const interval = setInterval(() => {
            setWaSimStep((step) => (step + 1) % 6);
        }, 2200);
    ...
    const [ugcProduct, setUgcProduct] = useState("Suero Capilar");
            ...
            <style>{`
                ...
                * { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                .comparison-table-wrapper::after {
                    content: "↔️ Desliza horizontalmente para ver más";
                    display: none;
                    position: absolute;
                    bottom: -15px;
                    left: 50%;
...
<section className="hero-section" style={{ padding: "100px 24px 80px", position: "relative", overflow: "hidden", background: "transparent", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
                ...
                <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 2, width: "100%" }}>
                    ...
                    <p style={{ fontSize: 18, color: "#9CA3AF", maxWidth: 550, margin: "0 auto 48px", lineHeight: 1.6, fontWeight: 400 }}>
                        Solo describe tu producto. Nuestra IA investiga el mercado, encuentra los mejores ángulos de venta y crea más de 100 anuncios listos para probar en Meta Ads. Sin diseñador. Sin prompts. Sin experiencia.
                    </p>
...
{/* Gallery Section - Moved below Testimonials */}
            ...
            {/* UGC Image Generator Section */}
<section style={{ padding: "80px 24px 20px", background: "transparent", position: "relative", zIndex: 3, borderTop: "1px solid rgba(139, 92, 246, 0.1)" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    
                    {/* Header */}
                    <div style={{ textAlign: "center", marginBottom: 60 }}>
                        <div style={{ border: "1px solid rgba(139, 92, 246, 0.3)", color: "#A78BFA", fontSize: 11, fontWeight: 700, padding: "8px 24px", borderRadius: 100, display: "inline-flex", alignItems: "center", gap: 8, marginBottom: 20, letterSpacing: "0.1em", textTransform: "uppercase", background: "rgba(139, 92, 246, 0.05)" }}>
                            <Sparkles size={14} /> EXCLUSIVO DE CLICKADS
                        </div>
                        <h2 style={{ fontSize: "clamp(32px, 5vw, 56px)", fontWeight: 900, marginBottom: 24, lineHeight: 1.15 }}>
                            UGC <span className="gradient-text">Image Generator</span>
                        </h2>
                        <p style={{ fontSize: 19, color: "#9CA3AF", maxWidth: 750, margin: "0 auto", lineHeight: 1.6 }}>
                            No solo genera una imagen bonita. Crea una escena auténtica que parece una foto real tomada por un cliente o creador de contenido. La idea es que se vea 100% orgánica y funcione para anuncios.
                        </p>
                    </div>

                    {/* Gallery Showcase of 8 cards */}
                    <div style={{ background: "rgba(13, 13, 20, 0.4)", border: "1px solid rgba(255, 255, 255, 0.05)", borderRadius: 24, padding: "32px 32px 40px 32px", textAlign: "center" }}>
                        <h3 style={{ fontSize: 22, fontWeight: 900, marginBottom: 8, color: "#fff" }}>
                            📸 Fotos Reales desarrolladas por la herramienta:
                        </h3>
                        <p style={{ fontSize: 14, color: "#9CA3AF", marginBottom: 40 }}>
                            Ejemplos reales de creativos orgánicos de alta calidad creados instantáneamente con UGC Image Generator.
                        </p>
                        
                        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(230px, 1fr))", gap: 24 }}>
                            {[
                                { title: "Prebióticos Fem (Selfie)", img: "/ugc/gallery_fem_1.jpg", tag: "Suplementos Fem" },
                                { title: "Probióticos Fem (Selfie)", img: "/ugc/gallery_fem_2.jpg", tag: "Suplementos Fem" },
                                { title: "Proteína Shaker (Selfie)", img: "/ugc/ugc_man_1.png", tag: "Suplementos & Fitness" },
                                { title: "Serum Nocturno (Selfie)", img: "/ugc/ugc_man_2.png", tag: "Cuidado Masculino" }                            ].map((item, idx) => (
                                <div key={idx} style={{ background: "#0d0d14", borderRadius: 16, overflow: "hidden", border: "1px solid rgba(255,255,255,0.05)", display: "flex", flexDirection: "column", height: "100%", boxShadow: "0 8px 32px rgba(0,0,0,0.15)" }}>
                                    ...
                                    <div style={{ padding: "20px 16px", textAlign: "left", flex: 1, display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                                        <div style={{ fontSize: 14, fontWeight: 800, color: "#fff", marginBottom: 8 }}>{item.title}</div>
                                        <div>
                                            <span style={{ fontSize: 10, background: "rgba(139,92,246,0.1)", border: "1px solid rgba(139,92,246,0.2)", color: "#C4B5FD", padding: "4px 10px", borderRadius: 40, fontWeight: 700 }}>{item.tag}</span>
                                        </div>
                                    </div>
                                </div>
                            ))}                        </div>
            ...
            {/* WHATSAPP REVIEWS AI SECTION */}
<section style={{ padding: "20px 24px 100px", background: "transparent", position: "relative", zIndex: 3, borderTop: "1px solid rgba(139, 92, 246, 0.1)" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    
                    {/* Header */}
                    <div style={{ textAlign: "center", marginBottom: 60 }}>
                        <div style={{ border: "1px solid rgba(16, 185, 129, 0.3)", color: "#10B981", fontSize: 11, fontWeight: 700, padding: "8px 24px", borderRadius: 100, display: "inline-flex", alignItems: "center", gap: 8, marginBottom: 20, letterSpacing: "0.1em", textTransform: "uppercase", background: "rgba(16, 185, 129, 0.05)" }}>
                            <span>💬</span> NUEVA HERRAMIENTA DISPONIBLE
                        </div>
                        <h2 style={{ fontSize: "clamp(32px, 5vw, 56px)", fontWeight: 900, marginBottom: 24, lineHeight: 1.15 }}>
                            WhatsApp <span style={{ background: "linear-gradient(135deg, #10B981, #34D399)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Reviews AI</span>
                        </h2>
                        <p style={{ fontSize: 19, color: "#9CA3AF", maxWidth: 750, margin: "0 auto", lineHeight: 1.6 }}>
                            Genera capturas de pantalla hiperrealistas de conversaciones de WhatsApp de clientes felices con fotos de tu producto. Úsalas en tus landing pages y redes sociales para disparar la confianza de tus clientes.
                        </p>
                    </div>

                    {/* Features and Simulated GIF Grid */}
                    <div style={{ display: "grid", gridTemplateColumns: "1.1fr 1fr", gap: 48, alignItems: "center" }} className="mobile-grid-1">
                        
                        {/* Left: Product Advantages */}
                        <div style={{ textAlign: "left" }}>
                            <h3 style={{ fontSize: 24, fontWeight: 900, color: "#fff", marginBottom: 24 }}>
                                Genera pruebas sociales que cierran ventas solos
                            </h3>
                            <p style={{ fontSize: 15, color: "#9CA3AF", lineHeight: 1.7, marginBottom: 32 }}>
                                El 92% de los compradores en internet lee reseñas antes de comprar. Las capturas de WhatsApp de clientes reales enviando una foto de su pedido y agradeciendo son la prueba social con mayor conversión en el mercado.
                            </p>

                            <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
                                {[
                                    { icon: "💬", title: "Textos Persuasivos con IA", desc: "La IA redacta comentarios ultra-naturales, con jergas latinas, emojis y errores ortográficos comunes para simular la realidad." },
                                    { icon: "📸", title: "Integración de Producto Real", desc: "Sube la foto de tu producto y la IA la incrusta de forma nativa en la conversación como si el cliente la hubiera tomado." },
                                    { icon: "🎨", title: "Simulador de Interfaz de Alta Fidelidad", desc: "Elige nombres, fotos de perfil, nivel de batería, señal de Wi-Fi y hora exacta para crear la captura de pantalla perfecta." }
                                ].map((feat, idx) => (
                                    <div key={idx} style={{ display: "flex", gap: 16, alignItems: "flex-start" }}>
                                        ...
                                        <div>
                                            <h4 style={{ fontSize: 16, fontWeight: 800, color: "#fff", marginBottom: 4 }}>{feat.title}</h4>
                                            <p style={{ fontSize: 13, color: "#9CA3AF", lineHeight: 1.5 }}>{feat.desc}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
                        ...
                        {/* Right: Simulated GIF Interactive Mockup */}
                        <div>
                            <div style={{ textAlign: "center", fontSize: 12, color: "#6B7280", fontWeight: 700, marginBottom: 12, textTransform: "uppercase" }}>
                                ⚡ GIF Animado · Cómo funciona en 3 pasos:
                            </div>
                            ...
                            <div style={{
                                ...
                                boxShadow: "0 30px 60px rgba(0,0,0,0.5), 0 0 30px rgba(16,185,129,0.1)",
                                overflow: "hidden",
                                height: 480,
                                display: "flex",
                                ...
                                <div style={{ background: "#075E54", padding: "14px 16px", display: "flex", alignItems: "center", gap: 10, color: "#fff" }}>
                                    <div style={{ width: 36, height: 36, borderRadius: "50%", background: "#128C7E", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 800, fontSize: 14 }}>
                                        S
                                    </div>
                                    <div style={{ textAlign: "left", flex: 1 }}>
                                        <div style={{ fontWeight: 800, fontSize: 13 }}>Sofia Baena (Cliente)</div>
                                        <div style={{ fontSize: 10, color: "#34D399" }}>En línea</div>
                                    </div>
                                    <div style={{ fontSize: 14, opacity: 0.8 }}>📞 📹 ⋮</div>
                                </div>

                                {/* WhatsApp Background / Message List */}
                                <div style={{ flex: 1, background: "#efeae2", padding: 16, display: "flex", flexDirection: "column", gap: 10, overflowY: "auto", position: "relative" }}>
                                    
                                    {/* Simulated Steps Animation */}
                                    {waSimStep >= 1 && (
                                        <div style={{ alignSelf: "flex-start", maxWidth: "80%", background: "#fff", padding: 8, borderRadius: 8, boxShadow: "0 1px 2px rgba(0,0,0,0.15)", overflow: "hidden", border: "1px solid rgba(0,0,0,0.05)" }}>
                                            <img src="/ugc/fem_prebioticos.jpg" alt="Uploaded product" style={{ width: "100%", height: 160, objectFit: "cover", borderRadius: 6, display: "block" }} />
                                            <div style={{ fontSize: 10, color: "#9CA3AF", textAlign: "right", marginTop: 4 }}>10:44 p.m.</div>
                                        </div>
                                    )}

                                    {waSimStep >= 2 && (
                                        <div style={{ alignSelf: "flex-start", maxWidth: "80%", background: "#fff", padding: "8px 12px", borderRadius: "12px 12px 12px 0", fontSize: 12, color: "#111", boxShadow: "0 1px 2px rgba(0,0,0,0.15)", textAlign: "left" }}>
                                            {waSimStep === 2 ? (
                                                <div style={{ display: "flex", gap: 4, alignItems: "center", padding: "4px 0" }}>
                                                    <span style={{ width: 6, height: 6, background: "#888", borderRadius: "50%", animation: "typing 1.2s infinite" }} />
                                                    <span style={{ width: 6, height: 6, background: "#888", borderRadius: "50%", animation: "typing 1.2s infinite 0.2s" }} />
                                                    <span style={{ width: 6, height: 6, background: "#888", borderRadius: "50%", animation: "typing 1.2s infinite 0.4s" }} />
                                                </div>
                                            ) : (
                                                "¡Hola! Ya me llegaron los prebióticos Fem. Llevo unos días tomándolos y ya noto la diferencia en mi digestión y energía 🌟. ¡Súper recomendado!"
                                            )}
                                        </div>
                                    )}

                                    {waSimStep >= 4 && (
                                        <div style={{ alignSelf: "flex-end", maxWidth: "80%", background: "#dcf8c6", padding: "8px 12px", borderRadius: "12px 12px 0 12px", fontSize: 12, color: "#111", boxShadow: "0 1px 2px rgba(0,0,0,0.15)", textAlign: "left" }}>
                                            {waSimStep === 4 ? (
                                                <div style={{ display: "flex", gap: 4, alignItems: "center", padding: "4px 0" }}>
                                                    <span style={{ width: 6, height: 6, background: "#888", borderRadius: "50%", animation: "typing 1.2s infinite" }} />
                                                    <span style={{ width: 6, height: 6, background: "#888", borderRadius: "50%", animation: "typing 1.2s infinite 0.2s" }} />
                                                ...
                                                "¡Hola Sofia! Mil gracias por compartir tu experiencia 😍. Nos alegra mucho saber que te sirvieron tanto. ¡A seguir con el proceso!"
                                            )}
                                        </div>
                                    )}

                                    {/* Action Banner simulator overlay */}
                                    {waSimStep === 5 && (
                                        <div style={{ position: "absolute", inset: 0, background: "rgba(0,0,0,0.7)", backdropFilter: "blur(2px)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24, zIndex: 10 }}>
                                            <div style={{ background: "#0a0a0f", border: "1px solid rgba(16,185,129,0.3)", borderRadius: 16, padding: 20, textAlign: "center", maxWidth: 280 }}>
                                                <div style={{ fontSize: 24, marginBottom: 8 }}>✅</div>
                                                <div style={{ fontWeight: 800, color: "#fff", fontSize: 14, marginBottom: 4 }}>Captura de Pantalla Lista</div>
                                                <p style={{ fontSize: 11, color: "#9CA3AF", marginBottom: 16 }}>La IA ha procesado la conversación realista.</p>
                                                <button style={{ width: "100%", background: "#10B981", color: "#fff", border: "none", padding: "10px 14px", borderRadius: 8, fontSize: 11, fontWeight: 900, display: "flex", alignItems: "center", justifyContent: "center", gap: 6 }}>
                                                    <Download size={14} /> DESCARGAR CAPTURA PNG
                                                </button>
                                            </div>
                                        </div>
                                    )}
            ...
            {/* COMPARATIVE SECTION */}
            <section style={{ padding: "80px 24px 100px", background: "transparent", position: "relative", zIndex: 3, borderTop: "1px solid rgba(139, 92, 246, 0.1)" }}>
                <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                    ...
                    <div style={{ textAlign: "center", marginBottom: 50 }}>
                        ...
                        <h2 style={{ fontSize: "clamp(32px, 5vw, 48px)", fontWeight: 900, marginBottom: 16, lineHeight: 1.15 }}>
                            ClickADS frente a <span className="gradient-text">otras alternativas</span>
                        </h2>
                        <p style={{ fontSize: 16, color: "#9CA3AF", maxWidth: 600, margin: "0 auto", lineHeight: 1.6 }}>
                            Mira por qué ClickADS es la solución definitiva y más rentable para crear creativos y landings que sí venden en tu ecommerce.
                        </p>
                    </div>

                    {/* Table Container */}
                    <div className="comparison-table-wrapper" style={{ position: "relative", paddingBottom: "20px" }}>
                        <div className="comparison-table-container" style={{ 
                            ...
                            <table className="comparison-table" style={{ width: "100%", borderCollapse: "collapse", minWidth: 800, textAlign: "left" }}>
                            <thead>
                                <tr style={{ borderBottom: "1px solid rgba(255, 255, 255, 0.08)" }}>
                                    <th style={{ padding: "16px 20px", color: "#9CA3AF", fontWeight: 700, fontSize: 14 }}>Característica</th>
                                    <th style={{ 
                                        padding: "16px 20px", 
                                        color: "#A78BFA", 
                                        fontWeight: 900, 
                                    ...
                                    <th style={{ padding: "16px 20px", color: "#E5E7EB", fontWeight: 700, fontSize: 14, textAlign: "center" }}>ChatGPT</th>
                                    <th style={{ padding: "16px 20px", color: "#E5E7EB", fontWeight: 700, fontSize: 14, textAlign: "center" }}>Canva</th>
                                    <th style={{ padding: "16px 20px", color: "#E5E7EB", fontWeight: 700, fontSize: 14, textAlign: "center" }}>Diseñador Freelance</th>
                                </tr>
                            </thead>
                            <tbody>
                                {[
                                    { feat: "+100 creativos en minutos", c: "✅", g: "❌", cv: "❌", df: "❌" },
                                    { feat: "Ángulos de venta automáticos", c: "✅", g: "⚠️ Manual", cv: "❌", df: "⚠️ Depende" },
                                    { feat: "Diseñado para Meta Ads", c: "✅", g: "❌", cv: "❌", df: "⚠️" },
                                    { feat: "Investigación de mercado", c: "✅", g: "❌", cv: "❌", df: "❌" },
                                    { feat: "Landing Page IA", c: "✅", g: "❌", cv: "❌", df: "❌" },
                                    { feat: "Generador de UGC", c: "✅", g: "❌", cv: "❌", df: "❌" },
                                    { feat: "Exportar listo para Shopify", c: "✅", g: "❌", cv: "❌", df: "❌" },
                                    { feat: "Pago único", c: "✅", g: "❌ Suscripción", cv: "❌ Suscripción", df: "❌ Pago por proyecto" },
                                    { feat: "Pensado para ecommerce", c: "✅", g: "⚠️ General", cv: "⚠️ General", df: "⚠️" }
                                ].map((row, idx) => (
                                    <tr key={idx} style={{ 
                                        borderBottom: idx === 8 ? "none" : "1px solid rgba(255, 255, 255, 0.04)",
                                        background: idx % 2 === 0 ? "rgba(255, 255, 255, 0.01)" : "transparent"
                                    }}>
                                        <td style={{ padding: "18px 20px", color: "#E5E7EB", fontWeight: 600, fontSize: 14 }}>
                                            {row.feat}
                                        </td>
                                        <td style={{ 
                                            padding: "18px 20px", 
                                        ...
                                        <td style={{ padding: "18px 20px", color: row.g.includes("⚠️") ? "#FBBF24" : "#EF4444", fontSize: 13, textAlign: "center", fontWeight: 500 }}>
                                            {row.g}
                                        </td>
                                        <td style={{ padding: "18px 20px", color: row.cv.includes("⚠️") ? "#FBBF24" : "#EF4444", fontSize: 13, textAlign: "center", fontWeight: 500 }}>
                                            {row.cv}
                                        </td>
                                        <td style={{ padding: "18px 20px", color: row.df.includes("⚠️") ? "#FBBF24" : "#EF4444", fontSize: 13, textAlign: "center", fontWeight: 500 }}>
                                            {row.df}
                                        </td>
                                    </tr>
                                ))}
