            ...
            <section className="hero-section" style={{ padding: "140px 24px 80px", position: "relative", overflow: "hidden", background: "transparent", minHeight: "100vh", display: "flex", alignItems: "center" }}>
                ...
                <div style={{ maxWidth: 1000, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 2, width: "100%" }}>
                    ...
                    <h1 style={{ fontSize: "clamp(38px, 7vw, 72px)", fontWeight: 900, lineHeight: 1.1, letterSpacing: "-0.03em", marginBottom: 32, color: "#fff" }}>
                        ...
                        <span className="gradient-text">genere +100 imagenes que vendan en Meta ADS</span><br />
                        en segundos.
                    </h1>
                ...
                <div style={{ maxWidth: 1200, margin: "0 auto", textAlign: "center" }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }} className="mobile-grid-1">
                        ...
                        <div style={{ textAlign: "center" }}>
                            ...
                            <div style={{ background: "#111116", border: "1px solid rgba(255,255,255,0.05)", borderRadius: 24, padding: 32, display: "flex", flexDirection: "column", alignItems: "flex-start", position: "relative", zIndex: 5 }}>
                    ...
                    <div style={{ marginTop: 40, padding: "60px", background: "#0D0D14", borderRadius: 40, border: "1px solid rgba(255,255,255,0.05)", position: "relative", zIndex: 5 }} className="mobile-full-padding">
