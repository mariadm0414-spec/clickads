        ...
        <div style={{ background: "#030303", minHeight: "100vh", color: "#fff", fontFamily: "'Inter', sans-serif", padding: "80px 24px" }}>
            <div style={{ maxWidth: 800, margin: "0 auto" }}>
                ...
                <div style={{ color: "#9CA3AF", fontSize: 16, lineHeight: 1.8, display: "flex", flexDirection: "column", gap: 24 }}>
                    ...
                    <p>Al acceder y utilizar AdsTools, usted acepta estar sujeto a estos términos y condiciones. Si no está de acuerdo con alguna parte de los términos, por favor, no utilice nuestro software ni nuestros servicios.</p>
                    ...
                    <p>El servicio, la marca "AdsTools" y su diseño tecnológico subyacente son y seguirán siendo propiedad exclusiva de AdsTools. Por otro lado, usted mantiene la propiedad sobre los creativos comerciales producidos con la plataforma.</p>

                    <h2 style={{ color: "#fff", fontSize: 24, fontWeight: 800, marginTop: 24 }}>5. Limitación de responsabilidad</h2>
                    <p>En ningún caso AdsTools será responsable ante usted o cualquier tercero por daños consecuentes, lucro cesante o multas que experimente debido a la naturaleza de las campañas de Meta Ads hechas con el material generado.</p>
                </div>
            </div>
        </div>
    );
