...
export default function MariaBypassPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch("/api/auth/admin-bypass", {
                ...
                body: JSON.stringify({ password, user: "maria" })
            });
    ...
    return (
        <div style={{
            ...
            <style>{`
                ...
                .btn-auth:hover { background: #7C3AED; }
            `}</style>

            <div className="admin-card">
                <UserCheck size={48} color="#8B5CF6" style={{ margin: "0 auto 20px" }} />
                <h1 style={{ fontSize: 24, fontWeight: 900, marginBottom: 10 }}>Acceso VIP: María</h1>
