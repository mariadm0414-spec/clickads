...
export default function SignupPage() {
    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        try {
            // 1. Verificar si el usuario ya está pre-autorizado (compró en Hotmart)
            // Esto asume que el webhook de Hotmart ya creó la entrada con el email.
            ...
            if (!authData) {
                setError("Este correo no está registrado como comprador. Si acabas de comprar, espera 5 minutos o contacta a soporte.");
                setIsLoading(false);
                return;
            }

            // 2. Actualizar el registro con el nombre y "contraseña"
            // Nota: Aquí se guarda la contraseña. En un entorno real se debería usar Supabase Auth 
            // o encriptar este campo. Para este MVP lo guardaremos en authorized_users.
            ...
            setSuccess(true);
            setTimeout(() => {
                router.push("/login"); // Enviar a login como pidió el usuario
            }, 2000);
