        ...
        <div style={{ background: "#030303", minHeight: "100vh", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
            <div style={{ maxWidth: 400, width: "100%" }}>
                ...
                <div style={{ textAlign: "center", marginBottom: 40 }}>
                    ...
                    <h1 style={{ fontSize: 32, fontWeight: 900, marginBottom: 8 }}>Únete a AdsTools</h1>
                ...
                <form onSubmit={handleSignup} style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                    ...
                    <p style={{ textAlign: "center", color: "#9CA3AF", fontSize: 14, marginTop: 8 }}>
                        ¿Ya tienes cuenta? <Link href="/login" style={{ color: "#EF4444", textDecoration: "none", fontWeight: 600 }}>Inicia sesión</Link>
                    </p>
                </form>
            </div>
        </div>
