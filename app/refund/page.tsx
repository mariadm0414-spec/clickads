        ...
        <div style={{ background: "#030303", minHeight: "100vh", color: "#fff", fontFamily: "'Inter', sans-serif", padding: "80px 24px" }}>
            <div style={{ maxWidth: 800, margin: "0 auto" }}>
                ...
                <div style={{ color: "#9CA3AF", fontSize: 16, lineHeight: 1.8, display: "flex", flexDirection: "column", gap: 24 }}>
                    ...
                    <p>En AdsTools ofrecemos una garantía de 72 horas para asegurar que nuestra herramienta funciona correctamente de acuerdo a lo promocionado en nuestra oferta y publicidad digital.</p>
                    ...
                    <p>Ejercer la garantía de reembolso resulta irrevocablemente en el cierre al acceso de la plataforma de AdsTools una vez el saldo es remitido a cuenta original.</p>
                </div>
            </div>
        </div>
    );
