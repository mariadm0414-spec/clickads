...
export default function Home() {
    ...
    return (
        <div style={{ background: "#030303", minHeight: "100vh", color: "#fff", fontFamily: "'Inter', sans-serif", overflowX: "hidden", position: "relative" }}>
            ...
            <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 1000, background: "rgba(3,3,3,0.85)", backdropFilter: "blur(12px)", padding: "16px 24px", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
                <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                        <img src="/logo.png" alt="AdsTools" style={{ height: 40, width: "auto" }} />
                        <span style={{ fontSize: 22, fontWeight: 900, letterSpacing: "-0.04em" }}>AdsTools</span>
                    </div>
            ...
            <section className="hero-section" style={{ padding: "120px 24px 40px", maxWidth: 1200, margin: "0 auto", textAlign: "center" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 12, marginBottom: 40, flexWrap: "wrap", position: "relative", zIndex: 10 }}>
                    ...
                    <div style={{ textAlign: "left" }}>
                        ...
                        <div style={{ fontSize: 14, fontWeight: 700, color: "#9CA3AF" }}>
                            <span style={{ color: "#A78BFA" }}>+1,200</span> Dropshippers y dueños de Ecommerce ya escalan con <span style={{ color: "#fff" }}>AdsTools</span>
                        </div>
                    </div>
                </div>
                ...
                <div style={{ marginTop: 64, marginBottom: 64, textAlign: "center" }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: 48, flexWrap: "wrap", opacity: 0.8 }}>
                        ...
                        <div style={{ background: "rgba(139,92,246,0.05)", border: "1px solid rgba(139,92,246,0.2)", padding: "10px 24px", borderRadius: 100, fontSize: 14, fontWeight: 700, color: "#9CA3AF" }}>
                            ⚡ <span style={{ color: "#8B5CF6" }}>+50,000</span> creativos generados
                        </div>
                    </div>
                ...
                <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
                    ...
                    <div style={{ marginTop: 80, textAlign: "center" }}>
                        ...
                        <p style={{ fontSize: 18, color: "#9CA3AF", maxWidth: 750, margin: "0 auto", lineHeight: 1.6 }}>
                            Con <span style={{ color: "#fff", fontWeight: 700 }}>AdsTools</span>, vas a tener acceso al secreto mejor guardado de los que más facturan: <span style={{ color: "#A78BFA", fontWeight: 800 }}>VOLUMEN de creativos + testeo constante.</span>
                        </p>
                    </div>
            ...
            {/* UGC Video Showcase Section */}
            <section style={{ padding: "80px 24px", background: "linear-gradient(180deg, #030303 0%, #0D0D14 100%)" }}>
                <div style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }} className="mobile-grid-1">
                    
                    <div style={{ display: "flex", justifyContent: "center", order: 2 }} className="mobile-order-1">
                        <div style={{ width: "100%", maxWidth: 320, aspectRatio: "9/16", background: "#111", borderRadius: 32, border: "8px solid #1a1a1a", overflow: "hidden", position: "relative", boxShadow: "0 0 50px rgba(139, 92, 246, 0.2)" }}>
                            <img src="/100ecom/landing3.jpeg" alt="UGC Video Demo" style={{ width: "100%", height: "100%", objectFit: "cover", opacity: 0.8 }} />
                            <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: 64, height: 64, background: "rgba(139, 92, 246, 0.9)", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", boxShadow: "0 0 30px rgba(139, 92, 246, 0.6)" }}>
                                <div style={{ width: 0, height: 0, borderTop: "12px solid transparent", borderBottom: "12px solid transparent", borderLeft: "20px solid #fff", marginLeft: 6 }}></div>
                            </div>
                        </div>
                    </div>

                    <div style={{ textAlign: "left", order: 1 }} className="mobile-order-2">
                        <div style={{ background: "rgba(139,92,246,0.1)", border: "1px solid rgba(139,92,246,0.2)", color: "#A78BFA", fontSize: 10, fontWeight: 800, padding: "6px 16px", borderRadius: 100, display: "inline-flex", alignItems: "center", gap: 8, marginBottom: 24 }}>
                            <Zap size={12} /> GENERADOR DE VIDEOS UGC CON GROK
                        </div>
                        <h2 style={{ fontSize: "clamp(32px, 5vw, 64px)", fontWeight: 900, lineHeight: 1.1, marginBottom: 32 }}>
                            Guiones virales <span className="gradient-text">y videos UGC</span> al instante
                        </h2>
                        <p style={{ fontSize: 18, color: "#9CA3AF", lineHeight: 1.6, marginBottom: 40, margin: "0 auto 40px", maxWidth: 600 }}>
                            Integración exclusiva con Grok AI. Genera guiones persuasivos ultra-realistas y crea videos tipo UGC que conectan emocionalmente y detienen el scroll. Sin buscar actores.
                        </p>

                        <div style={{ display: "flex", flexDirection: "column", gap: 20, marginBottom: 40, alignItems: "flex-start" }}>
                            {[
                                { icon: "📝", text: "Guiones optimizados por Grok" },
                                { icon: "🤖", text: "Avatares IA ultra-realistas" },
                                { icon: "🎯", text: "Estructuras de venta comprobadas" },
                                { icon: "🚀", text: "Listos para escalar en TikTok" }
                            ].map((item, i) => (
                                <div key={i} style={{ display: "flex", alignItems: "center", gap: 16, fontSize: 16, fontWeight: 600, color: "#E5E7EB" }}>
                                    <div style={{ color: "#8B5CF6" }}>✓</div> {item.text}
                                </div>
                ...
                <div style={{ marginTop: 140, textAlign: "center" }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ position: "relative", zIndex: 2 }}>
                            <div style={{ background: "#8B5CF6", color: "#fff", fontSize: 12, fontWeight: 900, padding: "6px 16px", borderRadius: 100, display: "inline-block", marginBottom: 20, boxShadow: "0 0 20px rgba(139,92,246,0.5)" }}>SUPER BONUS EXTRA (VALORADO EN $199 USD)</div>
                            ...
                            <p style={{ fontSize: "clamp(14px, 1.5vw, 16px)", color: "#A78BFA", lineHeight: 1.6, maxWidth: 700, margin: "20px auto 0", fontWeight: 700 }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                            {[
                                ...
                                <div key={idx} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: 15, borderBottom: idx !== 9 ? "1px solid rgba(255,255,255,0.03)" : "none", paddingBottom: idx !== 9 ? 16 : 0 }}>
                                    ...
                                    <div style={{ color: "#A78BFA", fontWeight: 700 }}>{item.v}</div>
                                </div>
                            ))}
                        </div>
                    </div>
            ...
            <footer style={{ padding: "80px 24px 40px", borderTop: "1px solid rgba(255,255,255,0.05)", textAlign: "center" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12, justifyContent: "center", marginBottom: 24 }}>
                    <img src="/logo.png" alt="AdsTools" style={{ height: 50, width: "auto" }} />
                    <span style={{ fontSize: 24, fontWeight: 900 }}>AdsTools</span>
                </div>
