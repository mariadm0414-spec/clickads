...
export default function LandingBuilder() {
    ...
    const handleGenerate = async () => {
        const userStr = localStorage.getItem("adstools_user");
        let userEmail = "";
        if (userStr) {
            try { userEmail = JSON.parse(userStr).email || ""; } catch (e) { }
        }
        const apiKey = (userEmail ? localStorage.getItem(`adstools_api_key_${userEmail}`) : null) || localStorage.getItem("adstools_api_key_global");
                            ...
                            <div>
                                ...
                                >
                                    {selectedTemplate ? (
                                        ...
                                        <>
                                            <div style={{ width: "48px", height: "48px", borderRadius: "50%", background: "#EF4444", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "12px" }}>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px", marginBottom: "24px", background: "#27272A", padding: "20px", borderRadius: "12px", border: "1px solid rgba(255,255,255,0.05)" }}>
                            <div style={{ position: "relative" }}>
                                ...
                                <div
                                    ...
                                    style={{ background: "#18181B", border: isSizeOpen ? "1px solid #EF4444" : "1px solid rgba(255,255,255,0.1)", borderRadius: "8px", padding: "12px 16px", fontSize: "14px", color: "#fff", display: "flex", justifyContent: "space-between", alignItems: "center", cursor: "pointer" }}
                                >
                                    {outputSize}
                            ...
                            {templatesToShow.length > 0 ? templatesToShow.map((tpl) => (
                                <div
                                    ...
                                    style={{
                                        ...
                                        cursor: "pointer",
                                        border: selectedTemplate?.id === tpl.id ? "3px solid #EF4444" : "3px solid transparent",
                                        display: "flex",
                                        alignItems: "flex-end",
                                        justifyContent: "center",
                                        color: "#fff",
