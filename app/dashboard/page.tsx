            ...
            for (const ratio of ratiosToGenerate) {
                const res = await fetch("/api/vertex-ai/generate-1plus4", {
                    ...
                    body: JSON.stringify({
                        ...
                        apiKey: apiKey,
                        specificAngle: angle || selectedAngle,
                        count: count,
        ...
        try {
            const res = await fetch("/api/vertex-ai/logo", {
                ...
                body: JSON.stringify({
                    ...
                    likedLogos: finalLogo ? [...likedLogos, finalLogo] : likedLogos,
                    positiveFeedback: logoLikedFeedback,
                    negativeFeedback: logoDislikedFeedback,
                    apiKey: apiKey
                }),
            });
            ...
            if (data.logo) {
                ...
                throw new Error(data.error || "Error generando el logo.");
            }
        } catch (error: any) {
