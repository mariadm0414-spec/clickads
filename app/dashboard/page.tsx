        ...
        <div style={{ background: "#030303", minHeight: "100vh", color: "#fff", fontFamily: "Inter, sans-serif", display: "flex" }}>
            ...
            <aside style={{ width: 280, borderRight: "1px solid rgba(255,255,255,0.05)", padding: "40px 24px", display: "flex", flexDirection: "column", height: "100vh", position: "fixed", background: "#050505" }}>
                ...
                <nav style={{ display: "flex", flexDirection: "column", gap: 6, flex: 1, overflowY: 'auto' }} className="custom-scrollbar">
                    ...
                    <div className={`nav-item ${activeTab === 'wa_sim' ? 'active' : ''}`} onClick={() => setActiveTab('wa_sim')}><MessageSquare size={18} /> Simulador Closer <span style={{ fontSize: 9, background: "#25D366", color: "#fff", padding: "2px 6px", borderRadius: 4, marginLeft: 8, fontWeight: 900 }}>HOT</span></div>
            ...
            <main style={{ marginLeft: 300, flex: 1, padding: "40px 20px", overflowX: 'hidden' }}>
                            ...
                            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 40 }}>
                                <div className="glass-card" style={{ padding: 24 }}>
                                    ...
                                    <div style={{ position: "relative", paddingBottom: "56.25%", height: 0 }}>
                                        <iframe
                                            src="https://www.loom.com/embed/3ab9022f14e74b0db41a8efc11d7b5de"
                                            frameBorder="0"
                                            allowFullScreen
                                ...
                                <div className="glass-card" style={{ padding: 24 }}>
                                    <h3 style={{ fontSize: 20, fontWeight: 700, marginBottom: 16 }}>Seccion Simulador Closer</h3>
                                    <div style={{ position: "relative", paddingBottom: "56.25%", height: 0 }}>
                                        <iframe
                                            src="https://www.loom.com/embed/c261d7ff3a89469a9e689072d4719b1d"
                                            frameBorder="0"
                                            allowFullScreen
                                            style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", borderRadius: 12 }}>
                                        </iframe>
                                ...
                                <div className="glass-card" style={{ padding: 24 }}>
                                    <h3 style={{ fontSize: 20, fontWeight: 700, marginBottom: 16 }}>Seccion Analisis Financiero</h3>
                                    <div style={{ position: "relative", paddingBottom: "56.25%", height: 0 }}>
                                        <iframe
                                            src="https://www.loom.com/embed/6d63141f47574ff4b221f948e65a6fcd"
                                            frameBorder="0"
                                            allowFullScreen
                                            style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", borderRadius: 12 }}>
                                        </iframe>
...

                {
                    activeTab === 'wa_sim' && (
                        <div style={{ width: "100%" }} className="anim-in">
                            <div style={{ marginBottom: 24 }}>
                                <button onClick={() => setTutorialVideoOpen('https://www.loom.com/embed/c261d7ff3a89469a9e689072d4719b1d')} style={{ cursor: 'pointer', border: 'none', display: 'inline-flex', alignItems: 'center', gap: 8, background: 'rgba(139, 92, 246, 0.1)', color: '#8B5CF6', padding: '8px 16px', borderRadius: 8, fontSize: 12, fontWeight: 800, textDecoration: 'none' }}>
                                <PlayCircle size={16} /> Ir a video tutorial de esta sección
                            </button>
                            </div>
                            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 32, gap: 24 }}>
                                <div style={{ flex: 1 }}>
                                    <h1 style={{ fontSize: 32, fontWeight: 900, marginBottom: 8, display: "flex", alignItems: "center", gap: 12 }}>
                                        <MessageSquare size={28} color="#25D366" /> Simulador de Cierre de Ventas
                                    </h1>
                                    <p style={{ color: "#9CA3AF" }}>Entrena tu capacidad de persuasión enfrentándote a diferentes tipos de clientes en un entorno real de WhatsApp.</p>
                                </div>
                                <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                                    <div style={{ textAlign: "right" }}>
                                        <label style={{ fontSize: 10, fontWeight: 900, color: "#9CA3AF", display: "block", marginBottom: 4 }}>PROYECTO ACTIVO</label>
                                        <select
                                            value={activeProjectId || ""}
                                            onChange={(e) => setActiveProjectId(e.target.value)}
                                            style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", color: "#fff", padding: "8px 16px", borderRadius: 10, fontSize: 14, fontWeight: 700, outline: "none", cursor: "pointer" }}
                                        >
                                    ...
                                    <div style={{ textAlign: "right" }}>
                                        <label style={{ fontSize: 10, fontWeight: 900, color: "#9CA3AF", display: "block", marginBottom: 4 }}>TIPO DE CLIENTE</label>
                                        <select
                                            value={waSimClientType}
                                            onChange={(e) => setWaSimClientType(e.target.value)}
                                            style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", color: "#fff", padding: "8px 16px", borderRadius: 10, fontSize: 14, fontWeight: 700, outline: "none", cursor: "pointer" }}
                                        >
                                            {WA_CLIENT_TYPES.map(type => <option key={type} value={type}>{type}</option>)}
                                        </select>
                                    </div>

                                    <button
                                        onClick={() => { setWaSimMessages([]); setWaSimEvaluation(null); }}
                                        style={{ background: "rgba(239, 68, 68, 0.1)", border: "1px solid rgba(239, 68, 68, 0.2)", color: "#EF4444", width: 46, height: 46, borderRadius: 12, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}
                            ...
                            <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: 32, alignItems: "start" }}>
                                ...
                                <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
                                    {/* Chat Area */}
                                    <div className="glass-card" style={{ display: "flex", flexDirection: "column", height: 700, overflow: "hidden", position: "relative" }}>
                                        {/* Header Chat */}
                                        <div style={{ padding: "20px 24px", background: "rgba(37, 211, 102, 0.1)", display: "flex", alignItems: "center", gap: 16, borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
                                            <div style={{ width: 44, height: 44, borderRadius: "50%", background: "#128C7E", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18 }}>👤</div>
                                            <div>
                                                <div style={{ fontWeight: 800, fontSize: 16 }}>Cliente Interesado (AI)</div>
                                                <div style={{ fontSize: 12, color: "#25D366", fontWeight: 700 }}>Online</div>
                                            </div>
                                        </div>

                                        {/* Messages Display */}
                                        <div style={{ flex: 1, overflowY: "auto", padding: 24, display: "flex", flexDirection: "column", gap: 16, background: "rgba(0,0,0,0.2)" }} className="custom-scrollbar">
                                            {waSimMessages.length === 0 ? (
                                                <div style={{ height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: 40 }}>
                                                    <div style={{ opacity: 0.3, marginBottom: 24, display: "flex", flexDirection: "column", alignItems: "center" }}>
                                                        <MessageSquare size={48} style={{ marginBottom: 16 }} />
                                                        <p style={{ fontWeight: 700 }}>Inicia la conversación</p>
                                                        <p style={{ fontSize: 12 }}>Escribe un saludo o una oferta para comenzar la simulación.</p>
                                                    </div>
                                                    <button
                                                        onClick={handleWaSimStart}
                                                        disabled={isWaSimLoading || !activeProjectId}
                                                        className="btn-primary"
                                                        style={{
                                                            background: "#25D366",
                                                            color: "#fff",
                                                    ...
                                                    >
                                                        {isWaSimLoading ? <Loader2 className="animate-spin" /> : <><PlayCircle size={20} /> INICIAR CONVERSACIÓN</>}
                                                    </button>
                                                    {!activeProjectId && (
                                                        <p style={{ color: "#EF4444", fontSize: 11, marginTop: 12, fontWeight: 700 }}>⚠️ Selecciona un proyecto arriba primero</p>
                                                    )}
                                                </div>
                                            ) : (
                                                waSimMessages.map((msg, i) => (
                                                    <div key={i} style={{
                                                        alignSelf: msg.role === 'user' ? 'flex-end' : 'flex-start',
                                                        maxWidth: '80%',
                                                        padding: "12px 16px",
                                                        borderRadius: msg.role === 'user' ? "16px 16px 0 16px" : "16px 16px 16px 0",
                                                        background: msg.role === 'user' ? "#056162" : "#262D31",
                                                        color: "#E9EDEF",
                                                        fontSize: 14,
                                                        lineHeight: "1.5",
                                                        position: "relative",
                                            ...
                                            {isWaSimLoading && (
                                                <div style={{ alignSelf: 'flex-start', background: "#262D31", padding: "12px 16px", borderRadius: "16px 16px 16px 0", display: "flex", gap: 4 }}>
                                                    <span className="dot-blink" style={{ width: 6, height: 6, background: "#888", borderRadius: "50%" }}></span>
                                                    <span className="dot-blink" style={{ width: 6, height: 6, background: "#888", borderRadius: "50%", animationDelay: "0.2s" }}></span>
                                                    <span className="dot-blink" style={{ width: 6, height: 6, background: "#888", borderRadius: "50%", animationDelay: "0.4s" }}></span>
                                                    <style>{`
                                        ...
                                        {/* Input Area */}
                                        <div style={{ padding: 20, background: "rgba(255,255,255,0.02)", borderTop: "1px solid rgba(255,255,255,0.05)", display: "flex", gap: 12 }}>
                                            <input
                                                className="input-field"
                                                placeholder="Escribe tu respuesta aquí..."
                                                value={waSimInput}
                                                onChange={(e) => setWaSimInput(e.target.value)}
                                                onKeyDown={(e) => e.key === 'Enter' && handleWaSimMessage()}
                                                style={{ marginBottom: 0 }}
                                            />
                                            <button
                                                onClick={handleWaSimMessage}
                                                disabled={isWaSimLoading || !waSimInput.trim()}
                                                className="btn-primary"
                                                style={{ padding: "0 24px", background: "#25D366" }}
                                            >
                                                <Send size={18} />
                                            </button>
                                        </div>
                                            ...
                                            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start", marginBottom: 32 }}>
                                                <div>
                                                    <h2 style={{ fontSize: 24, fontWeight: 900, marginBottom: 8, display: "flex", alignItems: "center", gap: 12 }}>
                                                        <ShieldCheck size={28} color="#8B5CF6" /> Reporte de Desempeño
                                                    </h2>
                                                    <p style={{ color: "#9CA3AF", fontSize: 14 }}>Análisis generado por IA basado en tu última interacción.</p>
                                                </div>
                                                <div style={{ textAlign: "center", background: "rgba(139, 92, 246, 0.1)", padding: "16px 24px", borderRadius: 24, border: "1px solid rgba(139, 92, 246, 0.2)" }}>
                                                    <div style={{ fontSize: 10, fontWeight: 900, color: "#8B5CF6", marginBottom: 4 }}>PUNTAJE GENERAL</div>
                                                    <div style={{ fontSize: 32, fontWeight: 900, color: "#fff" }}>{waSimEvaluation.score?.overall}%</div>
                                                </div>
                                            </div>

                                            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 24, marginBottom: 40 }}>
                                                <div style={{ background: "rgba(255,255,255,0.03)", padding: 20, borderRadius: 20 }}>
                                                    <div style={{ fontSize: 11, fontWeight: 900, color: "#9CA3AF", marginBottom: 12 }}>RAPPORT / CONEXIÓN</div>
                                                    <div style={{ height: 6, background: "rgba(255,255,255,0.1)", borderRadius: 3, overflow: "hidden" }}>
                                                        <div style={{ width: `${(waSimEvaluation.score?.rapport || 0) * 10}%`, height: "100%", background: "#8B5CF6" }} />
                                                    </div>
                                                </div>
                                                <div style={{ background: "rgba(255,255,255,0.03)", padding: 20, borderRadius: 20 }}>
                                                    <div style={{ fontSize: 11, fontWeight: 900, color: "#9CA3AF", marginBottom: 12 }}>MANEJO OBJECIONES</div>
                                                    <div style={{ height: 6, background: "rgba(255,255,255,0.1)", borderRadius: 3, overflow: "hidden" }}>
                                                        <div style={{ width: `${(waSimEvaluation.score?.objections || 0) * 10}%`, height: "100%", background: "#25D366" }} />
                                                    </div>
                                                </div>
                                                <div style={{ background: "rgba(255,255,255,0.03)", padding: 20, borderRadius: 20 }}>
                                                    <div style={{ fontSize: 11, fontWeight: 900, color: "#9CA3AF", marginBottom: 12 }}>CIERRE DE VENTA</div>
                                                    <div style={{ height: 6, background: "rgba(255,255,255,0.1)", borderRadius: 3, overflow: "hidden" }}>
                                                        <div style={{ width: `${(waSimEvaluation.score?.closing || 0) * 10}%`, height: "100%", background: "#F59E0B" }} />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 40 }}>
                                                <div>
                                                    <h3 style={{ fontSize: 18, fontWeight: 800, marginBottom: 20, display: "flex", alignItems: "center", gap: 10 }}>
                                                        <Activity size={18} color="#8B5CF6" /> Análisis Detallado
                                                    </h3>
                                                    <div style={{
                                                        fontSize: 14,
                                                        color: "#D1D5DB",
                                                        ...
                                                        {waSimEvaluation.report}
                                                    </div>
                                                </div>

                                                <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
                                                    <div>
                                                        <h3 style={{ fontSize: 16, fontWeight: 800, marginBottom: 16, color: "#EF4444" }}>Puntos a Mejorar</h3>
                                                        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                                                            {waSimEvaluation.improvements?.map((imp: string, i: number) => (
                                                                <div key={i} style={{ display: "flex", gap: 12, fontSize: 13, color: "#9CA3AF", background: "rgba(239, 68, 68, 0.05)", padding: 12, borderRadius: 12 }}>
                                                                    <div style={{ minWidth: 20, height: 20, borderRadius: 10, background: "rgba(239, 68, 68, 0.2)", display: "flex", alignItems: "center", justifyContent: "center", color: "#EF4444", fontSize: 10 }}>{i + 1}</div>
                                                                    {imp}
                                                                </div>
                                                            ))}
                                                        </div>
                                                    ...
                                                    <div style={{ background: "rgba(37, 211, 102, 0.05)", padding: 24, borderRadius: 24, border: "1px solid rgba(37, 211, 102, 0.1)" }}>
                                                        <h3 style={{ fontSize: 16, fontWeight: 800, marginBottom: 12, color: "#25D366", display: "flex", alignItems: "center", gap: 8 }}>
                                                            <Brain size={18} /> Chat Ganador (Ejemplo)
                                                        </h3>
                                                        <div style={{ fontSize: 12, color: "#E9EDEF", fontStyle: "italic", lineHeight: "1.6", whiteSpace: "pre-wrap" }}>
                                                            "{waSimEvaluation.expertCopy}"
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                {/* Right Aside */}
                                <aside className="glass-card" style={{ padding: 24, position: "sticky", top: 0 }}>
                                    <h3 style={{ fontSize: 18, fontWeight: 800, marginBottom: 16 }}>Instrucciones</h3>
                                    <ul style={{ fontSize: 13, color: "#9CA3AF", padding: 0, listStyle: "none", display: "flex", flexDirection: "column", gap: 12 }}>
                                        <li style={{ display: "flex", gap: 10 }}><CheckCircle2 size={14} color="#25D366" /> Elige un proyecto activo.</li>
                                        <li style={{ display: "flex", gap: 10 }}><CheckCircle2 size={14} color="#25D366" /> Inicia la charla con el botón central.</li>
                                        <li style={{ display: "flex", gap: 10 }}><CheckCircle2 size={14} color="#25D366" /> Usa técnicas de persuasión.</li>
                                        <li style={{ display: "flex", gap: 10 }}><CheckCircle2 size={14} color="#25D366" /> Presiona Evaluar Cierre al terminar.</li>
                                    </ul>
                                    <button
                                        onClick={handleWaSimEvaluate}
                                        disabled={isEvaluatingWa || isWaSimLoading || waSimMessages.length < 2}
                                        className="btn-primary"
                                        style={{ width: "100%", marginTop: 24, background: "#8B5CF6", justifyContent: "center" }}
                                    >
                                        {isEvaluatingWa ? <Loader2 className="animate-spin" /> : "Evaluar Cierre"}
                                    </button>
                                </aside>
                            </div>
                        </div>
...

                {
                    activeTab === 'financial' && (
                        <div style={{ width: "100%" }} className="anim-in">
                            <div style={{ marginBottom: 24 }}>
                                <button onClick={() => setTutorialVideoOpen('https://www.loom.com/embed/6d63141f47574ff4b221f948e65a6fcd')} style={{ cursor: 'pointer', border: 'none', display: 'inline-flex', alignItems: 'center', gap: 8, background: 'rgba(139, 92, 246, 0.1)', color: '#8B5CF6', padding: '8px 16px', borderRadius: 8, fontSize: 12, fontWeight: 800, textDecoration: 'none' }}>
                                <PlayCircle size={16} /> Ir a video tutorial de esta sección
                            </button>
                            </div>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 32 }}>
                                <h1 style={{ fontSize: 32, fontWeight: 900, display: 'flex', alignItems: 'center', gap: 12 }}>
                                    <TrendingUp size={28} color="#10b981" /> Análisis Financiero
                                </h1>
                                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                                    <label style={{ fontSize: 12, fontWeight: 700, color: '#9CA3AF' }}>Moneda:</label>
                                    <select
                                        value={finMoneda}
                                        onChange={(e) => setFinMoneda(e.target.value)}
                                        style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', color: '#fff', borderRadius: 8, padding: '4px 12px', fontSize: 13, fontWeight: 700, outline: 'none' }}
                                    >
