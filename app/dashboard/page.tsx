    ...
    const handleGenerateLanding = async () => {
        ...
        try {
            ...
            if (part && part.inlineData) {
                ...
                updateActiveProject({ results: [...(activeProject.results || []), { image: newImg, title: landingCategory, angle: landingCategory || "Landing" }] });
            } else {
                                    ...
                                    <div className="glass-card" style={{ padding: 40, background: "rgba(0,0,0,0.3)", position: "relative", minHeight: 600 }}>
                                        ...
                                        {landingResults ? (
                                            <div style={{ position: "relative" }}>
                                                ...
                                                <img src={landingResults.image} style={{ width: "100%", borderRadius: 16, boxShadow: "0 20px 40px rgba(0,0,0,0.4)" }} />
                                            </div>
                                        ) : (
